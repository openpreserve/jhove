 ...
 *
 * <p>The earlier version of this class displayed a single file. This version is controlled by a
...
public class ViewWindow extends InfoWindow {
  ...
  /**
   * Appends the representation of a RepInfo object to the tree. The RepInfo object is saved into a
   * list so that the window contents can be saved to a file later.
   */
  ...
  /**
   * Invoked when the "Close" menu item is selected. Overrides the parent class's method to delete
