...
/**
 * This is an output handler which connects JHOVE output to the Swing interface of the viewer
 * application. It is responsible for creating appropriate windows and making them known to (?).
 *
 * @author Gary McGath
 */
public class ViewHandler extends HandlerBase {
   ...
   *
   * @param jhwin The JhoveWindow which acts as the parent to output windows.
   */
  ...
  /**
   * Outputs the information contained in a RepInfo object. showHeader must be called to set up the
   * ViewWindow before this is called.
   *
   * <p>I need to break out part of the ViewWindow code to here so it can produce the output for one
   * file.
   */
  @Override
