...
We run online JHOVE Hack Days where volunteers from around the world work collaboratively to enhance our understanding of JHOVE errors and improve documentation. The [report](http://openpreservation.org/blog/2017/05/09/jhove-spring-clean/) from the most recent hack day is published on the Foundation’s website. If you would like to contribute or get involved in the next hack day, please [contact us](http://openpreservation.org/about/contact/).
