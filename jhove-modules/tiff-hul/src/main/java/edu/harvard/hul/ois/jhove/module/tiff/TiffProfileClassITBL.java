 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-BP makes use of all the features and functionality
 * supported by the TIFF and TIFF/IT fields appropriate to binary line art images."
 *
 * @author Gary McGath
 */
public final class TiffProfileClassITBL extends TiffProfileClassIT {
  public TiffProfileClassITBL() {
    super();
    _profileText = "TIFF/IT-BL (ISO 12639:1998)";
  }
