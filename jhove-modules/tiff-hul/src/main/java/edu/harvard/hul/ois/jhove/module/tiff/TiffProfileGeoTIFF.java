...
public final class TiffProfileGeoTIFF extends TiffProfile {
  ...
  /**
   * Returns true if the IFD satisfies the requirements of the the profile. See the GeoTIFF
  ...
  public boolean satisfiesThisProfile(IFD ifd) {
     ...
     * must be present. */
    boolean hasModelTiepoint = (tifd.getModelTiepointTag() != null);
    boolean hasModelTransformation = (tifd.getModelTransformationTag() != null);
