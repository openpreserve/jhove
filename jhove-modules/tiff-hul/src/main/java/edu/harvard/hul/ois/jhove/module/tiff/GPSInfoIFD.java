...
public class GPSInfoIFD extends IFD {
  ...
  public Property getProperty(boolean rawOutput) {
    ...
    if (_gpsLatitudeRef != null) {
      entries.add(new Property("GPSLatitudeRef", PropertyType.STRING, _gpsLatitudeRef));
    }
    if (_gpsLatitude != null) {
      entries.add(
          new Property("GPSLatitude", PropertyType.RATIONAL, PropertyArity.ARRAY, _gpsLatitude));
    }
    if (_gpsLongitudeRef != null) {
      entries.add(new Property("GPSLongitudeRef", PropertyType.STRING, _gpsLongitudeRef));
    }
    if (_gpsLongitude != null) {
      entries.add(
          new Property("GPSLongitude", PropertyType.RATIONAL, PropertyArity.ARRAY, _gpsLongitude));
    }
    entries.add(new Property("GPSAltitudeRef", PropertyType.INTEGER, new Integer(_gpsAltitudeRef)));
    if (_gpsAltitude != null) {
      entries.add(new Property("GPSAltitude", PropertyType.RATIONAL, _gpsAltitude));
    }
    if (_gpsTimeStamp != null) {
      entries.add(
          new Property("GPSTimeStamp", PropertyType.RATIONAL, PropertyArity.ARRAY, _gpsTimeStamp));
    }
    if (_gpsSatellites != null) {
      entries.add(new Property("GPSSatellites", PropertyType.STRING, _gpsSatellites));
    }
    if (_gpsStatus != null) {
      entries.add(new Property("GPSStatus", PropertyType.STRING, _gpsStatus));
    }
    if (_gpsMeasureMode != null) {
      entries.add(new Property("GPSMeasureMode", PropertyType.STRING, _gpsMeasureMode));
    }
    if (_gpsDOP != null) {
      entries.add(new Property("GPSDOP", PropertyType.RATIONAL, _gpsDOP));
    }
    entries.add(new Property("GPSSpeedRef", PropertyType.STRING, _gpsSpeedRef));
    if (_gpsSpeed != null) {
      entries.add(new Property("GPSSpeed", PropertyType.RATIONAL, _gpsSpeed));
    }
    entries.add(new Property("GPSTrackRef", PropertyType.STRING, _gpsTrackRef));
    if (_gpsTrack != null) {
      entries.add(new Property("GPSTrack", PropertyType.RATIONAL, _gpsTrack));
    }
    entries.add(new Property("GPSImgDirectionRef", PropertyType.STRING, _gpsImgDirectionRef));
    if (_gpsImgDirection != null) {
      entries.add(new Property("GPSImgDirection", PropertyType.RATIONAL, _gpsImgDirection));
    }
    if (_gpsMapDatum != null) {
      entries.add(new Property("GPSMapDatum", PropertyType.STRING, _gpsMapDatum));
    }
    if (_gpsDestLatitudeRef != null) {
      entries.add(new Property("GPSDestLatitudeRef", PropertyType.STRING, _gpsDestLatitudeRef));
    }
    if (_gpsDestLatitude != null) {
      entries.add(
          new Property(
              "GPSDestLatitude", PropertyType.RATIONAL, PropertyArity.ARRAY, _gpsDestLatitude));
    }
    if (_gpsDestLongitudeRef != null) {
      entries.add(new Property("GPSDestLongitudeRef", PropertyType.STRING, _gpsDestLongitudeRef));
    }
    if (_gpsDestLongitude != null) {
      entries.add(
          new Property(
              "GPSDestLongitude", PropertyType.RATIONAL, PropertyArity.ARRAY, _gpsDestLongitude));
    }
    entries.add(new Property("GPSDestBearingRef", PropertyType.STRING, _gpsDestBearingRef));
    if (_gpsDestBearing != null) {
      entries.add(new Property("GPSDestBearing", PropertyType.RATIONAL, _gpsDestBearing));
    }
    entries.add(new Property("GPSDestDistanceRef", PropertyType.STRING, _gpsDestDistanceRef));
    if (_gpsDestDistance != null) {
      entries.add(new Property("GPSDestDistance", PropertyType.RATIONAL, _gpsDestDistance));
    }
    ...
    if (_gpsDateStamp != null) {
      entries.add(new Property("GPSDateStamp", PropertyType.STRING, _gpsDateStamp));
    }
    entries.add(
        new Property("GPSDifferential", PropertyType.INTEGER, new Integer(_gpsDifferential)));
  ...
  public void lookupTag(int tag, int type, long count, long value) throws TiffException {
    try {
      if (tag == GPSALTITUDE) {
        ...
        _info.setMessage(
            new ErrorMessage(
                MessageConstants.TIFF_HUL_17,
                MessageFormat.format(MessageConstants.TIFF_HUL_17_SUB.getMessage(), tag),
                value));
      }
    } catch (IOException e) {
      String mess = MessageFormat.format(MessageConstants.TIFF_HUL_18.getMessage(), tag);
      JhoveMessage message =
          JhoveMessages.getMessageInstance(MessageConstants.TIFF_HUL_18.getId(), mess);
