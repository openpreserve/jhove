 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-HC makes use of all the features and functionality
 * supported by the TIFF and TIFF/IT fields appropriate to high resolution continuous tone images."
 *
 * @author Gary McGath
 */
public final class TiffProfileClassITHC extends TiffProfileClassIT {
  ...
  public boolean satisfiesThisProfile(IFD ifd) {
    ...
    if (niso.getBitsPerSample() == null || niso.getSamplesPerPixel() == NisoImageMetadata.NULL) {
      return false;
    }
