 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-MP makes use of all the features and functionality
 * supported by the TIFF and TIFF/IT fields appropriate to monochrome continuous tone picture
 * images."
 *
 * @author Gary McGath
 */
