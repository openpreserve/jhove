 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-SD makes use of all the features and functionality
 * supported by the TIFF and TIFF/IT fields appropriate to prescreened (copydot) colour separation
 * images."
 *
 * @author Gary McGath
 */
