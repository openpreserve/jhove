 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-HC/P1 is a simplified image file format profile for high
 * resolution continuous tone (HC) image data and can be considered a constrained subset of
 * TIFF/IT-HC specifically intended for simpler implementation."
 *
 * @author Gary McGath
 */
