...
/**
 * Profile checker for TIFF FX, Profile F, aka TIFF-F. This supersedes the Class F profile
 * (TiffProfileClassF), which will be deprecated and removed from the Jhove application.
 *
...
public class TiffProfileFXF extends TiffFXBase {
  ...
  /**
   * Returns true if the IFD satisfies the requirements of a TIFF/FX S profile. See the TIFF/FX
  ...
  public boolean satisfiesThisProfile(IFD ifd) {
    ...
    if (xRes == 300 && yRes == 300 && (wid == 2592 || wid == 3072 || wid == 3648)) {
      xywOK = true;
    }
    if (((xRes == 408 && yRes == 391) || (xRes == 400 && yRes == 400))
