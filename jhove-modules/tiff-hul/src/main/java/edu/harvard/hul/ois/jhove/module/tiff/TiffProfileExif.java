...
/**
 * Profile checker for Exif. This applies to the main IFD of the file. To satisfy the Exif profile,
 * the thumbnail IFD must also satisfy TiffProfileExifThumb.
 *
...
public final class TiffProfileExif extends TiffProfile {
  ...
  private static final String[] PROFILE_TEXTS = {
    "Exif 2.0",
  ...
  /**
   * Returns true if the IFD satisfies the requirements of an Exif profile. See the Exif
