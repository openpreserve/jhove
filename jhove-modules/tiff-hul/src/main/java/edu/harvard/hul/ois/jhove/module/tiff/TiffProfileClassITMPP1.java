 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-MP/P1 is a simplified image file format profile for
 * monochrome continuous tone picture image (MP) data and can be considred a constrained subset of
 * TIFF/IT-MP specifically intended for simpler implementation."
 *
 * @author Gary McGath
 */
