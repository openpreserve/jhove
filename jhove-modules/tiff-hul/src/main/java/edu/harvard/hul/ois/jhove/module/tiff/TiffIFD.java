...
public class TiffIFD extends IFD {
  ...
  private static final String[] OPIPROXY_L = {
    "no higher-resolution version exists", "higher-resolution version exists"
  };
  ...
  private static final String[] SAMPLEFORMAT_L = {
    "", "unsigned integer", "signed integer", "IEEE floating point", "undefined"
  };
  /** SubfileType tag (255) labels. */
  private static final String[] SUBFILETYPE_L = {
    "", "full-resolution image", "reduced-resolution image", "single page of multi-page image"
  };
  /** Threshholding tag (263) labels. */
  private static final String[] THRESHHOLDING_L = {
    "", "no dithering or halftoning", "ordered dithering or halftoning", "randomized process"
  };
  ...
  public static final String[] HCUSAGE_L = {
    ...
    "line art (line work) information",
    "trapping information"
  };
  public static final String[] IMAGECOLORINDICATOR_L = {
    "image not defined", "image color defined", "full transparency, image color not defined"
  };
  ...
  /** Exif tags. */
  private static final int EXIFIFD = 34665, GPSINFOIFD = 34853, INTEROPERABILITYIFD = 40965;
  ...
  private static final int JPEGTABLES = 347, IMAGESOURCEDATA = 37724;

  /** More Photoshop TIFF tags. */
  private static final int PHOTOSHOPPROPS = 34377, ANNOTATIONS = 50255;

  /** Class F tags. */
  private static final int BADFAXLINES = 326, CLEANFAXDATA = 327, CONSECUTIVEBADFAXLINES = 328;

  /** XMP tag. */
  private static final int XMP = 700;

  /** TIFF/FX tags. */
  private static final int GLOBALPARAMETERSIFD = 400, STRIPROWCOUNTS = 559, IMAGELAYER = 34732;
  ...
  private static final int DNGVERSION = 50706,
      ...
      SHADOWSCALE = 50739, // Undocumented
      // tag
  ...
  private void addNisoProperties(List<Property> entries, boolean rawOutput) {
    entries.add(new Property("NisoImageMetadata", PropertyType.NISOIMAGEMETADATA, _niso));
  }

  /* Add non-NISO properties. */
  private void addMiscProperties(List<Property> entries, boolean rawOutput) {
    if (_imageDescription != null) {
      entries.add(new Property("ImageDescription", PropertyType.STRING, _imageDescription));
    }
    if (_dateTime != null) {
      entries.add(new Property("DateTime", PropertyType.STRING, _dateTime));
    }
    if (_newSubfileType != 0L || rawOutput) {
      entries.add(
          addBitmaskProperty("NewSubfileType", _newSubfileType, NEWSUBFILETYPE_L, rawOutput));
    } else {
    ...
    if (_subfileType != NULL && (_subfileType != 0 || rawOutput)) {
      entries.add(addIntegerProperty("SubfileType", _subfileType - 1, SUBFILETYPE_L, rawOutput));
    } else if (_subfileType != NULL) {
      // if 0, always report as a raw number
      entries.add(new Property("SubfileType", PropertyType.LONG, new Long(_subfileType)));
    }
    if (_documentName != null) {
      entries.add(new Property("DocumentName", PropertyType.STRING, _documentName));
    }
    if (_pageName != null) {
      entries.add(new Property("PageName", PropertyType.STRING, _pageName));
    }
    if (_pageNumber != null) {
      entries.add(
          new Property("PageNumber", PropertyType.INTEGER, PropertyArity.ARRAY, _pageNumber));
    }
    if (_xPosition != null) {
      entries.add(addRationalProperty("XPosition", _xPosition, rawOutput));
    }
    if (_yPosition != null) {
      entries.add(addRationalProperty("YPosition", _yPosition, rawOutput));
    }
    if (_copyright != null) {
      entries.add(new Property("Copyright", PropertyType.STRING, _copyright));
    }
    if (_fillOrder != NULL) {
      entries.add(addIntegerProperty("FillOrder", _fillOrder, FILLORDER_L, rawOutput));
    }
    entries.add(
        new Property("SampleFormat", PropertyType.INTEGER, PropertyArity.ARRAY, _sampleFormat));
    if (_minSampleValue != null) {
      entries.add(
          new Property(
              "MinSampleValue", PropertyType.INTEGER, PropertyArity.ARRAY, _minSampleValue));
    }
    if (_maxSampleValue != null) {
      entries.add(
          new Property(
              "MaxSampleValue", PropertyType.INTEGER, PropertyArity.ARRAY, _maxSampleValue));
    }
    if (_inkSet != NULL) {
      entries.add(addIntegerProperty("InkSet", _inkSet, INKSET_L, rawOutput));
    }
    if (_numberOfInks != NULL) {
      entries.add(new Property("NumberOfInks", PropertyType.INTEGER, _numberOfInks));
    }
    if (_inkNames != null) {
      entries.add(new Property("InkNames", PropertyType.STRING, PropertyArity.ARRAY, _inkNames));
    }
    if (_dotRange != null) {
      entries.add(new Property("DotRange", PropertyType.INTEGER, PropertyArity.ARRAY, _dotRange));
    }
    if (_targetPrinter != null) {
      entries.add(new Property("TargetPrinter", PropertyType.STRING, _targetPrinter));
    }
    if (_halftoneHints != null) {
      entries.add(
          new Property("HalftoneHints", PropertyType.INTEGER, PropertyArity.ARRAY, _halftoneHints));
    }
    if (_cellLength != NULL) {
    ...
    if (_transferFunction) {
      entries.add(new Property("TransferFunction", PropertyType.BOOLEAN, Boolean.TRUE));
    }
    if (_transferRange != null) {
      entries.add(
          new Property("TransferRange", PropertyType.INTEGER, PropertyArity.ARRAY, _transferRange));
    }
    entries.add(new Property("Threshholding", PropertyType.INTEGER, _threshholding));
    if (_predictor != NULL) {
      entries.add(addIntegerProperty("Predictor", _predictor, PREDICTOR_L, rawOutput));
    }
    if (_t4Options != NULL) {
    ...
    if (_jpegProc != NULL) {
      entries.add(addIntegerProperty("JPEGProc", _jpegProc, JPEGPROC_L, JPEGPROC_INDEX, rawOutput));
    }
    ...
    if (_jpegInterchangeFormatLength != NULL) {
      entries.add(
          new Property(
              "JPEGInterchangeFormatLength", PropertyType.LONG, _jpegInterchangeFormatLength));
    }
    if (_jpegRestartInterval != NULL) {
      entries.add(new Property("JPEGRestartInterval", PropertyType.INTEGER, _jpegRestartInterval));
    }
    ...
    if (_jpegQTables != null) {
      entries.add(
          new Property("JPEGQTables", PropertyType.LONG, PropertyArity.ARRAY, _jpegQTables));
    }
    if (_jpegDCTables != null) {
      entries.add(
          new Property("JPEGDCTables", PropertyType.LONG, PropertyArity.ARRAY, _jpegDCTables));
    }
    if (_jpegACTables != null) {
      entries.add(
          new Property("JPEGACTables", PropertyType.LONG, PropertyArity.ARRAY, _jpegACTables));
    }
    if (_jpegTables != null) {
      entries.add(
          new Property("JPEGTables", PropertyType.INTEGER, PropertyArity.ARRAY, _jpegTables));
    }
    if (_imageSourceData != null) {
      entries.add(
          new Property(
              "ImageSourceData", PropertyType.INTEGER, PropertyArity.ARRAY, _imageSourceData));
    }
    if (_photoshopProperties != null) {
      entries.add(
          new Property(
              ...
              PropertyType.INTEGER,
              PropertyArity.ARRAY,
              _photoshopProperties));
    }
    if (_annotations != null) {
      entries.add(
          new Property("Annotations", PropertyType.INTEGER, PropertyArity.ARRAY, _annotations));
    }
    if (_clipPath != null) {
      entries.add(new Property("ClipPath", PropertyType.INTEGER, PropertyArity.ARRAY, _clipPath));
    }
    ...
    if (_cleanFaxData != NULL) {
      entries.add(new Property("CleanFaxData", PropertyType.LONG, new Long(_cleanFaxData)));
    }
    ...
    if (_consecutiveBadFaxLines != NULL) {
      entries.add(
          new Property("ConsecutiveBadFaxLines", PropertyType.LONG, _consecutiveBadFaxLines));
    }
    if (_freeByteCounts != null) {
      entries.add(
          new Property("FreeByteCounts", PropertyType.LONG, PropertyArity.ARRAY, _freeByteCounts));
    }
    if (_freeOffsets != null) {
      entries.add(
          new Property("FreeOffsets", PropertyType.LONG, PropertyArity.ARRAY, _freeOffsets));
    }
  }
  ...
  private void addTiffITProperties(List<Property> entries, boolean rawOutput) {
    ...
    if (_colorTable != null) {
      itList.add(
          new Property("ColorTable", PropertyType.INTEGER, PropertyArity.ARRAY, _colorTable));
    }
    itList.add(
        addIntegerProperty(
    ...
    if (_backgroundColorValue != NULL) {
      itList.add(new Property("BackgroundColorValue", PropertyType.INTEGER, _backgroundColorValue));
    }
    itList.add(
        addIntegerProperty(
            "ImageColorIndicator", _imageColorIndicator, IMAGECOLORINDICATOR_L, rawOutput));
    itList.add(
        addIntegerProperty(
            "TransparencyIndicator", _transparencyIndicator, TRANSPARENCYINDICATOR_L, rawOutput));
    ...
    if (_colorCharacterization != null) {
      itList.add(
          new Property("ColorCharacterization", PropertyType.STRING, _colorCharacterization));
    }
    if (_colorSequence != null) {
      itList.add(new Property("ColorSequence", PropertyType.STRING, _colorSequence));
    }
    if (_hcUsage != NULL) {
      itList.add(addBitmaskProperty("HCUsage", _hcUsage, HCUSAGE_L, rawOutput));
    }
    if (_it8Header != null) {
      itList.add(new Property("IT8Header", PropertyType.STRING, _it8Header));
    }
    ...
    itList.add(
        new Property("BitsPerExtendedRunLength", PropertyType.INTEGER, _bitsPerExtendedRunLength));
    entries.add(
        new Property("TIFFITProperties", PropertyType.PROPERTY, PropertyArity.LIST, itList));
  }
  ...
  private void addTiffEPProperties(List<Property> entries, boolean rawOutput) {
    ...
    if (_cfaPattern != null) {
      epList.add(
          new Property("CFAPattern", PropertyType.INTEGER, PropertyArity.ARRAY, _cfaPattern));
    }
    if (_batteryLevel != null) {
      epList.add(new Property("BatteryLevel", PropertyType.STRING, _batteryLevel));
    }
    if (_iptc != null) {
      epList.add(new Property("IPTCNAA", PropertyType.LONG, PropertyArity.ARRAY, _iptc));
    }
    if (_iccProfile != null) {
      epList.add(new Property("ICCProfile", PropertyType.BOOLEAN, Boolean.TRUE));
    }
    if (_exposureProgram != NULL) {
      epList.add(
          addIntegerProperty("ExposureProgram", _exposureProgram, EXPOSUREPROGRAM_L, rawOutput));
    }
    if (_spectralSensitivity != null) {
      epList.add(new Property("SpectralSensitivity", PropertyType.STRING, _spectralSensitivity));
    }
    if (_isoSpeedRatings != null) {
      epList.add(
          new Property(
              "ISOSpeedRatings", PropertyType.INTEGER, PropertyArity.ARRAY, _isoSpeedRatings));
    }
    if (_oecf != null) {
      epList.add(new Property("OECF", PropertyType.INTEGER, PropertyArity.ARRAY, _oecf));
    }
    if (_interlace != NULL) {
    ...
    if (_timeZoneOffset != null) {
      epList.add(
          new Property(
              "TimeZoneOffset", PropertyType.INTEGER, PropertyArity.ARRAY, _timeZoneOffset));
    }
    ...
    if (_compressedBitsPerPixel != null) {
      epList.add(addRationalProperty("CompressedBitsPerPixel", _compressedBitsPerPixel, rawOutput));
    }
    if (_shutterSpeedValue != null) {
      epList.add(addRationalProperty("ShutterSpeedValue", _shutterSpeedValue, rawOutput));
    }
    if (_aperatureValue != null) {
      epList.add(addRationalProperty("AperatureValue", _aperatureValue, rawOutput));
    }
    if (_maxAperatureValue != null) {
      epList.add(addRationalProperty("MaxAperatureValue", _maxAperatureValue, rawOutput));
    }
    if (_flash != NULL) {
      epList.add(addIntegerProperty("FLASH", _flash, FLASH_L, FLASH_INDEX, rawOutput));
    }
    ...
    if (_noise != null) {
      epList.add(new Property("Noise", PropertyType.INTEGER, PropertyArity.ARRAY, _noise));
    }
    if (_focalPlaneXResolution != null) {
      epList.add(addRationalProperty("FocalPlaneXResolution", _focalPlaneXResolution, rawOutput));
    }
    if (_focalPlaneYResolution != null) {
      epList.add(addRationalProperty("FocalPlaneYResolution", _focalPlaneYResolution, rawOutput));
    }
    ...
    if (_securityClassification != null) {
      epList.add(
          new Property("SecurityClassification", PropertyType.STRING, _securityClassification));
    }
    if (_imageHistory != null) {
      epList.add(new Property("ImageHistory", PropertyType.STRING, _imageHistory));
    }
    if (_subjectLocation != null) {
      epList.add(
          new Property(
              "SubjectLocation", PropertyType.INTEGER, PropertyArity.ARRAY, _subjectLocation));
    }
    if (_tiffEPStandardID != null) {
      epList.add(new Property("TIFFEPSStandardID", PropertyType.STRING, _tiffEPStandardID));
    }
    if (epList.size() > 0) {
      entries.add(
          new Property("TIFFEPProperties", PropertyType.PROPERTY, PropertyArity.LIST, epList));
    }
  ...
  private void addGeoTiffProperties(List<Property> entries, boolean rawOutput)
      ...
      for (int i = 0; i < _geoKeyDirectoryTag[3]; i++) {
        ...
        switch (key) {
          ...
          case GTCITATIONGEOKEY:
            dirList.add(new Property("GTCitation", PropertyType.STRING, sval));
            break;
          ...
          case GEOGCITATIONGEOKEY:
            dirList.add(new Property("GeogCitation", PropertyType.STRING, sval));
            break;
          ...
          case GEOGPRIMEMERIDIANLONGGEOKEY:
            dirList.add(new Property("GeogPrimeMeridianLong", PropertyType.DOUBLE, dval));
            break;
          ...
          case GEOGLINEARUNITSIZEGEOKEY:
            dirList.add(new Property("GeogLinearUnitSize", PropertyType.DOUBLE, dval));
            break;
          ...
          case GEOGANGULARUNITSIZEGEOKEY:
            dirList.add(new Property("GeogAngularUnitSize", PropertyType.DOUBLE, dval));
            break;
          ...
          case GEOGSEMIMAJORAXISGEOKEY:
            dirList.add(new Property("GeogSemiMajorAxis", PropertyType.DOUBLE, dval));
            break;
          case GEOGSEMIMINORAXISGEOKEY:
            dirList.add(new Property("GeogSemiMinorAxis", PropertyType.DOUBLE, dval));
            break;
          case GEOGINVFLATTENINGGEOKEY:
            dirList.add(new Property("GeogInvFlattening", PropertyType.DOUBLE, dval));
            break;
          ...
          case PCSCITATIONGEOKEY:
            dirList.add(new Property("PCSCitation", PropertyType.STRING, sval));
            break;
          ...
          case PROJLINEARUNITSIZEGEOKEY:
            dirList.add(new Property("ProjLinearUnitSize", PropertyType.DOUBLE, dval));
            break;
          case PROJSTDPARALLEL1GEOKEY:
            dirList.add(new Property("ProjStdParallel1", PropertyType.DOUBLE, dval));
            break;
          case PROJSTDPARALLEL2GEOKEY:
            dirList.add(new Property("ProjStdParallel2", PropertyType.DOUBLE, dval));
            break;
          case PROJNATORIGINLONGGEOKEY:
            dirList.add(new Property("ProjNatOriginLong", PropertyType.DOUBLE, dval));
            break;
          case PROJNATORIGINLATGEOKEY:
            dirList.add(new Property("ProjNatOriginLat", PropertyType.DOUBLE, dval));
            break;
          case PROJFALSEEASTINGGEOKEY:
            dirList.add(new Property("ProjFalseEasting", PropertyType.DOUBLE, dval));
            break;
          case PROJFALSENORTHINGGEOKEY:
            dirList.add(new Property("ProjFalseNorthing", PropertyType.DOUBLE, dval));
            break;
          case PROJFALSEORIGINLONGGEOKEY:
            dirList.add(new Property("ProjFalseOriginLong", PropertyType.DOUBLE, dval));
            break;
          case PROJFALSEORIGINLATGEOKEY:
            dirList.add(new Property("ProjFalseOriginLat", PropertyType.DOUBLE, dval));
            break;
          case PROJFALSEORIGINEASTINGGEOKEY:
            dirList.add(new Property("ProjFalseOriginEasting", PropertyType.DOUBLE, dval));
            break;
          case PROJFALSEORIGINNORTHINGGEOKEY:
          case PROJFALSEORIGINNORTHINGGEOKEY_2:
            dirList.add(new Property("ProjFalseOriginNorthing", PropertyType.DOUBLE, dval));
            break;
          case PROJCENTERLONGGEOKEY:
            dirList.add(new Property("ProjCenterLong", PropertyType.DOUBLE, dval));
            break;
          case PROJCENTERLATGEOKEY:
            dirList.add(new Property("ProjCenterLat", PropertyType.DOUBLE, dval));
            break;
          case PROJCENTEREASTINGGEOKEY:
            dirList.add(new Property("ProjCenterEasting", PropertyType.DOUBLE, dval));
            break;
          case PROJSCALEATNATORIGINGEOKEY:
            dirList.add(new Property("ProjScaleAtNatOrigin", PropertyType.DOUBLE, dval));
            break;
          case PROJSCALEATCENTERGEOKEY:
            dirList.add(new Property("ProjScaleAtCenter", PropertyType.DOUBLE, dval));
            break;
          case PROJAZIMUTHANGLEGEOKEY:
            dirList.add(new Property("ProjAzimuthAngle", PropertyType.DOUBLE, dval));
            break;
          case PROJSTRAIGHTVERTPOLELONGEOKEY:
            dirList.add(new Property("ProjStraightVertPoleLong", PropertyType.DOUBLE, dval));
            break;
          ...
          case VERTICALCITATIONGEOKEY:
            dirList.add(new Property("VerticalCitation", PropertyType.STRING, sval));
            break;
    ...
    if (dirList.size() > 0) {
      geoList.add(
          new Property("GeoKeyDirectory", PropertyType.PROPERTY, PropertyArity.LIST, dirList));
    }

    if (_modelTiepointTag != null) {
      geoList.add(
          new Property(
              "ModelTiepointTag", PropertyType.DOUBLE, PropertyArity.ARRAY, _modelTiepointTag));
    }
    if (_modelPixelScaleTag != null) {
      geoList.add(
          new Property(
              "ModelPixelScaleTag", PropertyType.DOUBLE, PropertyArity.ARRAY, _modelPixelScaleTag));
    }
    ...
    if (geoList.size() > 0) {
      entries.add(
          new Property("GeoTIFFProperties", PropertyType.PROPERTY, PropertyArity.LIST, geoList));
    }
  }
  ...
  private void addTiffFXProperties(List<Property> entries, boolean rawOutput) {
    if (_stripRowCounts != null) {
      entries.add(
          new Property("StripRowCounts", PropertyType.LONG, PropertyArity.ARRAY, _stripRowCounts));
    }
    if (_imageLayer != null) {
      // Do up ImageLayer as a property with two subproperties.
      Property[] layerProps = new Property[2];
      try {
        layerProps[0] = addIntegerProperty("LayerType", _imageLayer[0], IMAGELAYER_L, rawOutput);
        layerProps[1] = new Property("OrdinalNumber", PropertyType.INTEGER, _imageLayer[1]);

        entries.add(
            new Property("ImageLayer", PropertyType.PROPERTY, PropertyArity.ARRAY, layerProps));
      }
  ...
  private void addDNGProperties(List<Property> entries, boolean rawOutput) {
    ...
    if (_dngVersion != null) {
      dngList.add(
          new Property("DNGVersion", PropertyType.INTEGER, PropertyArity.ARRAY, _dngVersion));
    }
    ...
    if (_uniqueCameraModel != null) {
      dngList.add(new Property("UniqueCameraModel", PropertyType.STRING, _uniqueCameraModel));
    }
    if (_localizedCameraModel != null) {
      dngList.add(new Property("LocalizedCameraModel", PropertyType.STRING, _localizedCameraModel));
    }
    if (_cfaPlaneColor != null) {
      dngList.add(
          new Property("CFAPlaneColor", PropertyType.INTEGER, PropertyArity.ARRAY, _cfaPlaneColor));
    }
    if (_cfaLayout != NULL) {
      dngList.add(addIntegerProperty("CFALayout", _cfaLayout, CFALAYOUT_L, rawOutput));
    }
    ...
    if (_blackLevel != null) {
      dngList.add(
          new Property("BlackLevel", PropertyType.RATIONAL, PropertyArity.ARRAY, _blackLevel));
    }
    if (_blackLevelDeltaH != null) {
      dngList.add(
          new Property(
              "BlackLevelDeltaH", PropertyType.RATIONAL, PropertyArity.ARRAY, _blackLevelDeltaH));
    }
    if (_blackLevelDeltaV != null) {
      dngList.add(
          new Property(
              "BlackLevelDeltaV", PropertyType.RATIONAL, PropertyArity.ARRAY, _blackLevelDeltaV));
    }
    if (_whiteLevel != null) {
      dngList.add(new Property("WhiteLevel", PropertyType.LONG, PropertyArity.ARRAY, _whiteLevel));
    }
    if (_defaultScale != null) {
      dngList.add(
          new Property("DefaultScale", PropertyType.RATIONAL, PropertyArity.ARRAY, _defaultScale));
    }
    if (_bestQualityScale != null) {
      dngList.add(new Property("BestQualityScale", PropertyType.RATIONAL, _bestQualityScale));
    }
    if (_defaultCropOrigin != null) {
      dngList.add(
          new Property(
              "DefaultCropOrigin", PropertyType.RATIONAL, PropertyArity.ARRAY, _defaultCropOrigin));
    }
    if (_defaultCropSize != null) {
      dngList.add(
          new Property(
              "DefaultCropSize", PropertyType.RATIONAL, PropertyArity.ARRAY, _defaultCropSize));
    }
    ...
    if (_colorMatrix1 != null) {
      dngList.add(
          new Property("ColorMatrix1", PropertyType.RATIONAL, PropertyArity.ARRAY, _colorMatrix1));
    }
    if (_colorMatrix2 != null) {
      dngList.add(
          new Property("ColorMatrix2", PropertyType.RATIONAL, PropertyArity.ARRAY, _colorMatrix2));
    }
    ...
    if (_reductionMatrix1 != null) {
      dngList.add(
          new Property(
              "ReductionMatrix1", PropertyType.RATIONAL, PropertyArity.ARRAY, _reductionMatrix1));
    }
    if (_reductionMatrix2 != null) {
      dngList.add(
          new Property(
              "ReductionMatrix2", PropertyType.RATIONAL, PropertyArity.ARRAY, _reductionMatrix2));
    }
    if (_analogBalance != null) {
      dngList.add(
          new Property(
              "AnalogBalance", PropertyType.RATIONAL, PropertyArity.ARRAY, _analogBalance));
    }
    if (_asShotNeutral != null) {
      dngList.add(
          new Property(
              "AsShotNeutral", PropertyType.RATIONAL, PropertyArity.ARRAY, _asShotNeutral));
    }
    if (_asShotWhiteXY != null) {
      dngList.add(
          new Property(
              "AsShotWhiteXY", PropertyType.RATIONAL, PropertyArity.ARRAY, _asShotWhiteXY));
    }
    if (_baselineExposure != null) {
      dngList.add(new Property("BaselineExposure", PropertyType.RATIONAL, _baselineExposure));
    }
    if (_baselineNoise != null) {
      dngList.add(new Property("BaselineNoise", PropertyType.RATIONAL, _baselineNoise));
    }
    if (_baselineNoise != null) {
      dngList.add(new Property("BaselineSharpness", PropertyType.RATIONAL, _baselineSharpness));
    }
    ...
    if (_linearResponseLimit != null) {
      dngList.add(new Property("LinearResponseLimit", PropertyType.RATIONAL, _linearResponseLimit));
    }
    if (_cameraSerialNumber != null) {
      dngList.add(new Property("CameraSerialNumber", PropertyType.STRING, _cameraSerialNumber));
    }
    if (_lensInfo != null) {
      dngList.add(new Property("LensInfo", PropertyType.RATIONAL, PropertyArity.ARRAY, _lensInfo));
    }
    if (_chromaBlurRadius != null) {
      dngList.add(new Property("ChromaBlurRadius", PropertyType.RATIONAL, _chromaBlurRadius));
    }
    if (_antiAliasStrength != null) {
      dngList.add(new Property("AntiAliasStrength", PropertyType.RATIONAL, _antiAliasStrength));
    }
    if (_dngPrivateData != null) {
      dngList.add(new Property("DNGPrivateData", PropertyType.INTEGER, _dngPrivateData));
    }
    if (_makerNoteSafety != NULL) {
      dngList.add(
          addIntegerProperty("MakerNoteSafety", _makerNoteSafety, MAKERNOTESAFETY_L, rawOutput));
    }
    if (dngList.size() > 0) {
      entries.add(
          new Property("DNGProperties", PropertyType.PROPERTY, PropertyArity.LIST, dngList));
    }
  }

  /**
   * ColorPlanes is an undefined primary in the TIFF spec. It's actually a non-obvious definition
   * which is something of a pain to calculate.
   */
  ...
  /**
   * Set the default values for any DNG tags that haven't been encountered yet. If _dngVersion is
   * zero, apply the IFD 0 defaults; if PhotometricInterpretation is CFA or RawLinear, apply the Raw
   * IFD defaults.
   */
  private void setDNGDefaults() {
    ...
    if (_photometricInterpretation == TiffProfileDNG.CFA
      ...
      if (_blackLevel == null) {
        _blackLevel =
            new Rational
                [_blackLevelRepeatDim[0] * _blackLevelRepeatDim[1] * _niso.getSamplesPerPixel()];
    ...
    try {
      switch (tag) {
        ...
        case BRIGHTNESSVALUE:
          ...
          if (count == 1) {
            _niso.setBrightness(readSignedRational(count, value));
          } else {
            checkCountArray(tag, count);
        ...
        case COMPRESSION:
          ...
          if (scheme == 6) {
            _info.setMessage(new InfoMessage(MessageConstants.TIFF_HUL_61));
          }
          break;
        ...
        case EXPOSUREBIASVALUE:
          checkType(tag, type, SRATIONAL);
          if (count == 1) {
            _niso.setExposureBias(readSignedRational(count, value));
          } else {
            checkCountArray(tag, count);
            Rational[] r = readSignedRationalArray(count, value);
        ...
        case EXPOSURETIME:
          checkType(tag, type, RATIONAL);
          if (count == 1) {
            _niso.setExposureTime(readRational(count, value).toDouble());
          } else {
            checkCountArray(tag, count);
          ...
          for (int i = 0; i < num; i++) {
            ...
            if (prevKey > key) {
              ...
              JhoveMessage message =
                  JhoveMessages.getMessageInstance(MessageConstants.TIFF_HUL_10.getId(), mess);
          ...
          try {
            ...
            String mess =
                MessageFormat.format(
                    MessageConstants.TIFF_HUL_71.getMessage(), tag, ie.getMessage());
            JhoveMessage message =
                JhoveMessages.getMessageInstance(MessageConstants.TIFF_HUL_71.getId(), mess);
            throw new TiffException(message);
          }
          break;
        case INTERLACE:
        ...
        case PHOTOMETRICINTERPRETATION:
          ...
          if (_photometricInterpretation == 5) {
            ...
            if (_niso.getYCbCrCoefficients() == null) {
              _niso.setYCbCrCoefficients(
                  new Rational[] {
                    new Rational(299, 1000), new Rational(587, 1000), new Rational(114, 1000)
                  });
            }
          ...
          } else if (colorSpace == 5 || colorSpace == 6 || colorSpace == 8) {
            if (_version < 6) {
              _version = 6;
            }
          }
        ...
        case SHADOWSCALE:
          _info.setMessage(
              new InfoMessage(
                  MessageConstants.TIFF_HUL_11, MessageConstants.TIFF_HUL_11_SUB.getMessage()));
          break;
        case DNGPRIVATEDATA:
          checkType(tag, type, BYTE);
          checkCountArray(tag, count);
        ...
        case MAKERNOTESAFETY:
          ...
          break;
        default:
          String mess = MessageFormat.format(MessageConstants.TIFF_HUL_12.getMessage(), tag);
          JhoveMessage message =
              JhoveMessages.getMessageInstance(MessageConstants.TIFF_HUL_12.getId(), mess);
      ...
      JhoveMessage message =
          JhoveMessages.getMessageInstance(MessageConstants.TIFF_HUL_13.getId(), mess);
  ...
  protected void postParseInitialization() {
    ...
    if (_photometricInterpretation == 2 || _photometricInterpretation == 6) {
      ...
      if (_niso.getReferenceBlackWhite() == null) {
        ...
        reference[1] = reference[3] = reference[5] = new Rational(bps1, 1);
