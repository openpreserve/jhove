...
public class TiffProfileFXL extends TiffFXBase {
  ...
  /**
   * Returns true if the IFD satisfies the requirements of a TIFF/FX L profile. See the TIFF/FX
  ...
  public boolean satisfiesThisProfile(IFD ifd) {
    ...
    if (!satisfiesPhotometricInterpretation(tifd, new int[] {2, 5, 10})) {
      return false;
    }
    ...
    if (!satisfiesXResolution(tifd, new int[] {100, 200, 300, 400})) {
      return false;
    }
