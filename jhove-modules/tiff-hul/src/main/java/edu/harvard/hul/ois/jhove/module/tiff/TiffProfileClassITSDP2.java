 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-SD/P2 is a simplified file format profile for screened
 * data image (SD) data and can be considered a constrained subset of TIFF/IT-SD specifically
 * intended for simpler implementation."
 *
 * <p>There is no TIFF/IT-SD/P1.
 *
 * @author Gary McGath
 */
