...
/**
 * IFD 0 of a DNG document must satisfy this profile. It doesn't actually have to be a "thumbnail"
 * in the sense of containing a low-resolution image, but it has to contain the "IFD 0" tags
 * specified by DNG. In addition, some other document must satisfy <code>TiffProfileDNG</code>.
 *
 * @author Gary McGath
 * @see TiffProfileDNG
 */
