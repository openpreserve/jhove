...
/**
 * Abstract class for TIFF profile checkers. A profile applies to a given IFD; the caller should run
 * all profiles on all IFD's and accumulate a List of the Strings returned by <code>getText</code>
...
public abstract class TiffProfile {
  ...
  /**
   * Creates a TiffProfile. Subclass constructors should assign a value to _profileText, then call
   * the super constructor.
   *
   * <p>Sets _mimeClass to MIME_GENERIC. Profiles which indicate other MIME classes should assign a
   * different value to _mimeClass, which is the index into TiffModule.MIMETYPE that should be used.
   */
  public TiffProfile() {
    _alreadyOK = false;
  ...
  /**
   * Returns <code>true</code> if the IFD satisfies the profile. This calls <code>
   * satisfiesThisProfile()</code>, which does the actual work. <code>satisfiesProfile()</code> sets
   * the alreadyOK flag, which may be checked by calling <code>isAlreadyOK()</code> to save the
   * effort of testing the same profile more than once and thus generating duplicate output.
  ...
  /**
   * Returns <code>true</code> if the IFD satisfies the profile. Subclasses should override <code>
   * satisfiesThisProfile()</code>, not <code>satisfiesProfile()</code>, as <code>satisfiesProfile()
   * </code> does some additional bookkeeping for all subclases.
   */
  ...
  /**
   * Returns the MIME class for this profile. This will be one of the values MIME_GENERIC, MIME_FX,
   * and MIME_1314, corresponding to indices into TiffModule.MIMETYPE. All profiles which don't
   * imply a special MIME type other than image/tiff should take no special action, allowing
   * MIME_GENERIC to be returned. Classes which return a different value should assign that value to
   * MIME_CLASS in the constructor rather than overriding this.
   */
  ...
  /**
   * Returns the value of the alreadyOK flag. This flag can be used when a profile is being checked
   * against more than one IFD, to see if it has satisfied a previous IFD and thus avoid duplicate
   * profile listings. The alreadyOK flag is set whenever satisfiesProfile returns <code>true</code>
   * .
   */
   ...
   * @param values An array of values, any of which will satisfy the test.
   */
   ...
   *
   * @param ifd The IFD being checked
   * @param value A value which must match the tag value to satisfy the test.
   */
  ...
  /**
   * Checks if the value of the PhotometricInterpretation tag matches any of the values in the array
   * passed to it.
   *
   * @param ifd The IFD being checked
   * @param values An array of values, any of which will satisfy the test.
  ...
  /**
   * Checks if the value of the ResolutionUnit tag matches any of the values in the array passed to
   * it.
   *
   * @param ifd The IFD being checked
   * @param values An array of values, any of which will satisfy the test.
  ...
  /**
   * Checks if the value of the SamplesPerPixel tag matches any of the values in the array passed to
   * it.
   *
   * @param ifd The IFD being checked
   * @param values An array of values, any of which will satisfy the test.
  ...
  /**
   * Checks if the value of the PlanarConfiguration tag matches any of the values in the array
   * passed to it.
   *
   * @param ifd The IFD being checked
   * @param values An array of values, any of which will satisfy the test.
  ...
  /**
   * Checks if the value of the ImageColorIndicator tag matches any of the values in the array
   * passed to it.
   *
   * @param ifd The IFD being checked
   * @param values An array of values, any of which will satisfy the test.
  ...
  /**
   * Checks if the value of the NewSubfileType tag matches any of the values in the array passed to
   * it.
   *
   * @param ifd The IFD being checked
   * @param values An array of long values, any of which will satisfy the test.
   */
  ...
  /**
   * Checks if the value of the BackgroundColorIndicator tag matches any of the values in the array
   * passed to it.
   *
   * @param ifd The IFD being checked
   * @param values An array of values, any of which will satisfy the test.
  ...
  /**
   * Checks the DotRange against a minimum and a maximum value. Returns true if the DotRange exists,
   * is well-formed (i.e., has at least 2 values, and the first two values equal minValue and
