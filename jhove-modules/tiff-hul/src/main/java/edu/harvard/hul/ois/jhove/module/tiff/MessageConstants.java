 ...
 *
 * <ul>
 *   <li>WRN_ for warning strings, often logger messages.
...
public enum MessageConstants {
  ...
  public static final JhoveMessageFactory messageFactory =
      JhoveMessages.getInstance("edu.harvard.hul.ois.jhove.module.tiff.ErrorMessages");
  ...
  //	public static final String INF_STR_OFF_BYTE_COUNT_INCONS = "StripOffsets inconsistent with
  // StripByteCounts: ";
  ...
  //	 * Error messages
  //	 */
  //	public static final String ERR_CELL_LEN_NOT_ALLWD = "CellLength tag not permitted when
  // Threshholding not 2";
  //	public static final String ERR_CIELAB_BPS_NOT_8_OR_16 = "BitsPerSample not 8 or 16 for CIE
  // L*a*b*";
  //	public static final String ERR_COL_MAP_NOT_DEF = "ColorMap not defined for palette-color";
  //	public static final String ERR_COL_MAP_MISS_VALS = "Insufficient ColorMap values for
  // palette-color: ";
  ...
  //	public static final String ERR_DOT_RANGE_BPS = "DotRange out of range specified by
  // BitsPerSample";
  ...
  //	public static final String ERR_IFD_MAX_EXCEEDED = "More than 50 IFDs in chain, probably an
  // infinite loop";
  ...
  // ";
  //	public static final String ERR_PHO_AND_NEW_SUBFILE_INCONSISTENT = "PhotometricInterpretation
  // and NewSubfileType must agree on transparency mask";
  //	public static final String ERR_PHO_INT_SPP_GT_1 = "For PhotometricInterpretation,
  // SamplesPerPixel must be >= 1, equals: ";
  //	public static final String ERR_PHO_INT_SPP_GT_3 = "For PhotometricInterpretation,
  // SamplesPerPixel must be >= 3, equals: ";
  //	public static final String ERR_SPP_EXTRA_NT_1_OR_3 = "SamplesPerPixel-ExtraSamples not 1 or
  // 3:";
  ...
  //	public static final String ERR_TRANS_MASK_BPS = "For transparency mask BitsPerSample must be
  // 1";
