 ...
 *
 * <p>The TIFF/IT spec states that "TIFF/IT-LW/P1 is a simplified image file format profile for line
 * art (LW) image data and can be considered as a constrained subset of TIFF/IT-LW specified for
 * simpler implementation. TIFF/IT-LW/P2 can be considered as an extension of TIFF/IT-LW/P1."
 *
 * @author Gary McGath
 */
