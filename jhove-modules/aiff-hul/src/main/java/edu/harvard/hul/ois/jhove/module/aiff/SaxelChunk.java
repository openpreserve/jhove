 ...
 *
 * <p>The Saxel chunk has only a tentative and incomplete status in the AIFF-C draft of 1991, and
 * apparently nothing further was ever done with it. For purposes of extracting parameters, we treat
 * the description of the SaxelChunk and Saxels as valid, while regarding the SaxelData as opaque.
 *
 * @author Gary McGath
 */
public class SaxelChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    for (int i = 0; i < numSaxels; i++) {
      ...
      propArr[0] = new Property("ID", PropertyType.INTEGER, new Integer(id));
      propArr[1] = new Property("Size", PropertyType.INTEGER, new Integer(size));
      module.addSaxel(new Property("Saxel", PropertyType.PROPERTY, PropertyArity.ARRAY, propArr));
    }
    return true;
  }
}
