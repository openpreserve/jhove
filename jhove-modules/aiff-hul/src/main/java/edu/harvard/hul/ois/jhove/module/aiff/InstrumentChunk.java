...
public class InstrumentChunk extends Chunk {
  ...
  private class Loop {
    ...
    public Property loopProp(String name) {
      ...
      propArr[0] = _module.addIntegerProperty("PlayMode", playMode, AiffStrings.LOOP_TYPE);
      propArr[1] = new Property("BeginLoop", PropertyType.INTEGER, new Integer(beginLoop));
      propArr[2] = new Property("EndLoop", PropertyType.INTEGER, new Integer(endLoop));
      return new Property(name, PropertyType.PROPERTY, PropertyArity.ARRAY, propArr);
    }
  }
}
