 ...
 *
 * <p>The data bytes are put into an uninterpreted byte array Property. These are specified in the
 * AES Recommended Practice for Digital Audio Engineering - Serial Transmission Format for Linearly
 * Represented Digital Audio Data, Section 7.1, Channel Status Data.
 *
 * @author Gary McGath
 */
public class AudioRecChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    if (bytesLeft != 24) {
      ...
      info.setMessage(new ErrorMessage(MessageConstants.AIFF_HUL_6, module.getNByte()));
    ...
    module.addAiffProperty(
        new Property("AudioRecording", PropertyType.BYTE, PropertyArity.ARRAY, buf));
    return true;
  }
}
