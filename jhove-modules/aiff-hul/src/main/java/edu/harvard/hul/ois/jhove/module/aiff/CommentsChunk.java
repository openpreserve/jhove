...
public class CommentsChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    for (int i = 0; i < numComments; i++) {
      ...
      comAr[0] = new Property("Timestamp", PropertyType.DATE, jTimestamp);
      comAr[1] = new Property("CommentText", PropertyType.STRING, comment);
      comments.add(new Property("Comment", PropertyType.PROPERTY, PropertyArity.ARRAY, comAr));
    }
    module.addAiffProperty(
        new Property("Comments", PropertyType.PROPERTY, PropertyArity.LIST, comments));
