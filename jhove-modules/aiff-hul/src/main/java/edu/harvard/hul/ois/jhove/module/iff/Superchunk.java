...
/**
 * Abstract class for a chunk that contains other chunks. It is assumed that the nested chunks come
 * last in the chunk, so that once you start reading chunks, reaching the end of the superchunk is
 * the indicator that there are no more chunks to read.
 *
 * @author Gary McGath
 */
public abstract class Superchunk extends Chunk {
  ...
  /**
   * Reads and returns the next ChunkHeader within this Chunk, and takes care of byte counting. If
   * this Chunk is exhausted, returns null.
   */
