...
public class SoundDataChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    propArray[0] = new Property("Offset", PropertyType.LONG, new Long(offset));
    propArray[1] = new Property("BlockSize", PropertyType.LONG, new Long(blockSize));
    propArray[2] = new Property("DataLength", PropertyType.LONG, new Long(bytesLeft - 8));
    module.addAiffProperty(
        new Property("SoundData", PropertyType.PROPERTY, PropertyArity.ARRAY, propArray));
