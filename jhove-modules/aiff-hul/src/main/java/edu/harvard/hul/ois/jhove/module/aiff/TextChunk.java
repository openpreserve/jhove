...
/**
 * Abstract superclass for the name, author, copyright, and annotation chunks, all of which have the
 * same format.
 *
 * @author Gary McGath
 */
public abstract class TextChunk extends Chunk {
   ...
   *
   * <p>This method works for TextChunk, CopyrightChunk and AuthorChunk. AnnotationChunk overrides
   * it, since there can be multiple annotations.
   */
  @Override
  ...
  /**
   * Reads the chunk's text data. All text chunk subclasses consist of a text string which takes up
   * the full byte count of the chunk. By the specification, the text is required to be ASCII.
   */
