...
public abstract class Chunk {
  ...
  /**
   * Converts a byte buffer cleanly into an ASCII string. This is used for fixed-allocation strings
   * in Broadcast WAVE chunks, and might have uses elsewhere.
   *
   * <p>If a string is shorter than its fixed allocation, we're guaranteed only that there is a null
   * terminating the string, and noise could follow it. So we can't use the byte buffer constructor
   * for a string.
   */
