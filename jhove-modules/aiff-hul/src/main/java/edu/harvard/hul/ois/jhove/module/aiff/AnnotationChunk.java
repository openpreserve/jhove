...
public class AnnotationChunk extends TextChunk {
   ...
   */
  public AnnotationChunk(AiffModule module, ChunkHeader hdr, DataInputStream dstrm) {
   ...
   *
   * <p>There can be multiple Annotation Chunks, so we don't create a property here directly.
   *
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    ((AiffModule) _module).addAnnotation(new Property(propName, PropertyType.STRING, name));
    return true;
  }
}
