...
public class FormatVersionChunk extends Chunk {
   ...
   */
  public FormatVersionChunk(AiffModule module, ChunkHeader hdr, DataInputStream dstrm) {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    module.addAiffProperty(new Property("FormatVersion", PropertyType.DATE, jTimestamp));
    return true;
  }
}
