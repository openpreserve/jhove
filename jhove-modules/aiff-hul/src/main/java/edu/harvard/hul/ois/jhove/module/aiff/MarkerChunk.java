...
public class MarkerChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    for (int i = 0; i < numMarkers; i++) {
      ...
      mArr[0] = new Property("ID", PropertyType.INTEGER, new Integer(id));
      mArr[1] = new Property("Position", PropertyType.LONG, new Long(position));
      mArr[2] = new Property("Name", PropertyType.STRING, markerName);
      markerList.add(new Property("Marker", PropertyType.PROPERTY, PropertyArity.ARRAY, mArr));
    }
    module.addAiffProperty(
        new Property("Markers", PropertyType.PROPERTY, PropertyArity.LIST, markerList));
    return true;
  }
}
