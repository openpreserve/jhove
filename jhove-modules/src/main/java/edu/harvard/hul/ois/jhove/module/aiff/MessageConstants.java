 ...
 *
 */
package edu.harvard.hul.ois.jhove.module.aaif;
...
public static final String ERR_FORM_CHU_NOT_AAIF_STRING = "File type in Form Chunk is not AIFF or AIFC", ERR_FORM_CHU_NOT_AAIF_BYTES
public static final String ERR_NO_MULTI_CHU_NAME = chunkName
public static final String ERR_NO_MULTI_CHU_BYTES = _nByte
public static final String ERR_NO_MULTI_CHU_STRING = "Multiple " + ERR_NO_MULTI_CHU_NAME + " Chunks not permitted", ERR_NO_MULTI_CHU_BYTES
public static final String ERR_CHU_WRONG_SIZE_BYTES = //  module.getNByte ()
public static final String ERR_CHU_WRONG_SIZE_STRING = "Audio Recording Chunk is incorrect size", ERR_CHU_WRONG_SIZE_BYTES
public static final String ERR_NO_COMP_TYPE_BYTES =  // module.getNByte()
public static final String ERR_NO_COMP_TYPE_STRING = "Common Chunk in AIFF-C does not have compression type", ERR_NO_COMP_TYPE_BYTES
