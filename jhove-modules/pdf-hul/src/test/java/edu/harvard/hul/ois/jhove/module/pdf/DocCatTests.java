...
public class DocCatTests {
  ...
  private static final String oneByteMissingPath = pdfResourcePath + "corruptionOneByteMissing.pdf";

  private static final String catNoCat =
      docCatResourcePath + "T02-01_001_document-catalog-No-document-catalog.pdf";
  private static final String catWrongObjNumberPath =
      docCatResourcePath + "T02-01_002_document-catalog-wrong-object-number.pdf";
  private static final String catPagRefMissPath =
      docCatResourcePath + "T02-01_003_document-catalog-indirecte-pages-reference-missing.pdf";
  private static final String catPageRefIncorrectPath =
      docCatResourcePath + "T02-01_004_document-catalog-incorrect-pages-reference.pdf";
  private static final String catTypeKyMissPath =
      docCatResourcePath + "T02-01_005_document-catalog-type-key-missing.pdf";
  private static final String catTypeValNotCatalogPath =
      docCatResourcePath + "T02-01_006_document-catalog-wrong-type-key.pdf";
  private static final String catTypeKyValPairMissPath =
      docCatResourcePath + "T02-01_007_document-catalog-type-key-value-pair-missing.pdf";
