 ...
 * @version 0.1
 *     <p>Created 19 Mar 2018:02:03:50
 */
public class PageTreeTests {
  ...
  private static final String noPageTreeNodePath =
      pageTreeResourcePath + "T02-02_001_no-page-tree-node.pdf";
  private static final String rcrsPageTreeKidsPath =
      pageTreeResourcePath + "T02-02_002_page-tree-kids-links-recursive.pdf";
  private static final String diffPageTreeKidsPath =
      pageTreeResourcePath + "T02-02_003_page-tree-different-kids.pdf";
  private static final String ntExstPageTreeChldPath =
      pageTreeResourcePath + "T02-02_004_page-tree-non-existing-object-as-kid.pdf";
  private static final String noPageTreeKidsPath =
      pageTreeResourcePath + "T02-02_005_page-tree-no-kids.pdf";
  private static final String noTypePageTreePath =
      pageTreeResourcePath + "T02-02_006_page-tree-no-type.pdf";
  private static final String wrngPageTreeCountPath =
      pageTreeResourcePath + "T02-02_007_page-tree-wrong-count.pdf";
  private static final String noPageTreeCountPath =
      pageTreeResourcePath + "T02-02_008_page-tree-node-no-count.pdf";
  private static final String wrngPageTreeTypePath =
      pageTreeResourcePath + "T02-02_009_page-tree-wrong-type.pdf";
  ...
  public final void testValidCatType() throws URISyntaxException {
    TestUtils.testValidateResource(this.module, minimalPdfPath, RepInfo.TRUE, RepInfo.TRUE, null);
  }
  ...
  public final void testWrngPageTreeCount() throws URISyntaxException {
    TestUtils.testValidateResource(
        this.module, wrngPageTreeCountPath, RepInfo.TRUE, RepInfo.TRUE, null);
  }
