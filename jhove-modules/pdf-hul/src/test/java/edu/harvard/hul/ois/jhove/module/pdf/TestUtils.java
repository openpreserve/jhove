...
public final class TestUtils {
  ...
  public static void testValidateFile(
      final PdfModule pdfModule,
      final String pathToTest,
      final int expctWllFrmd,
      final int expctVld,
      final String expctMessage)
      throws URISyntaxException {
    File toTest = new File(TestUtils.class.getResource(pathToTest).toURI());
  ...
  private static void testResult(
      final RepInfo info, final int expctWllFrmd, final int expctVld, final String expctMessage) {
    String message =
    ...
    message = (expctVld == RepInfo.TRUE) ? "Should be valid." : "Should NOT be valid.";
