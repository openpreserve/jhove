...
/**
 * A representation of a PDF object which can be represented by a Token. In some cases, this means
 * that the full content of the object isn't stored, because we don't (think we) need it for our
 * purposes.
 */
public class PdfSimpleObject extends PdfObject {
  ...
  /**
   * Return the raw bytes of the token, as a Vector of Integer objects. Returns null if the token is
   * not a StringValuedToken.
   */
  ...
  /**
   * Return the integer value of the token. Throws a ClassCastException if the token is not a
   * Numeric.
   */
  ...
  /**
   * Return the <code>double</code> value of the token. Throws a ClassCastException if the token is
   * not a Numeric.
   */
  ...
  /**
   * Return <code>true</code> if the value of the token is the keyword "true", and false otherwise.
   */
  ...
  /**
   * Return <code>true</code> if the value of the token is the keyword "false", and false otherwise.
   */
