...
/**
 * This class holds the constants for standard structure type names, and a static method for
 * determining if a string belongs to those names.
 */
public class StdStructTypes {
  ...
  public static final String blockLevelNames[] = {
    "P", "H", "H1", "H2", "H3", "H4", "H5", "H6", "L", "LI", "Lbl", "LBody", "Table"
  };
