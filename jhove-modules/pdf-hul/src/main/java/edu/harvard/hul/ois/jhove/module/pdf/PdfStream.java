...
/**
 * A representation of a PDF stream object. A PdfStream consists of a dictionary and a stream token.
 * By default the content of the stream isn't loaded, but it can be loaded when necessary.
 */
public class PdfStream extends PdfObject {
   ...
   */
  public PdfStream(PdfDictionary dict, Stream stream, int objNumber, int genNumber)
      throws PdfException {
  ...
  /**
   * Returns an array (possibly empty but not null) of the filters for this Stream. The elements of
   * the array are Filter objects.
   */
  ...
  /**
   * Return the name of the filter, if the DecodeParams dictionary is present and has a "Name"
   * entry.
   */
