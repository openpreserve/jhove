...
public class PdfArray extends PdfObject {
   ...
   * Return an empty string if there are no PdfSimpleObjects.
   */
  ...
  /**
   * Attempts to convert this Array to a PDF rectangle. If the Array is a valid rectangle (i.e., an
   * array of exactly four numbers), returns a Java array of four doubles reflecting the rectangle.
