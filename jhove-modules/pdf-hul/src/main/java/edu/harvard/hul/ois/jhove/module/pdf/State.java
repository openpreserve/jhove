...
/**
 * An enumeration class for use with the Tokenizer. Only the static instances which are declared
 * within the class should ever be created.
 */
public class State {
  /* ****************************************************************
   * PUBLIC CLASS FIELDS.
  ...
  /** Constructor. It is private so that no other classes can create instances of State. */
