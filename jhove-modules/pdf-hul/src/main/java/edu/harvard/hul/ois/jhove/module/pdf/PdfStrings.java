...
public class PdfStrings {
  ...
  public static final String[] FONTDESCFLAGS = {
    "FixedPitch", // 1
    "Serif", // 2
    "Symbolic", // 3
    "Script", // 4
  ...
  public static final String[] USERPERMFLAGS3 = {
    "", // 1, reserved
    "", // 2, reserved
    "Print", // 3
    "Modify", // 4
  ...
  public static final String[] USERPERMFLAGS2 = {
    "", // 1, reserved
    "", // 2, reserved
    "Print", // 3
    "Modify", // 4
  ...
  public static final String[] ANNOTATIONFLAGS = {
    "Invisible", // 1
    "Hidden", // 2
    "Print", // 3
    "NoZoom", // 4
