...
public class Filter {
  ...
  /**
   * Returns the "Name" parameter of the filter, or <code>null</code> if there is no such parameter.
   * This is normally associated with a Crypt filter, and shouldn't be confused with the name of the
   * filter.
   */
  public String getNameParam() {
    try {
      if (_decodeParms != null) {
        PdfSimpleObject obj = (PdfSimpleObject) _decodeParms.get("Name");
