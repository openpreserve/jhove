...
/**
 * Abstract exception subclass used internally by the PDF module. Throwing a PDFException indicates
 * that the document is ill-formed or invalid; use the appropriate subclass to indicate which.
 */
public abstract class PdfException extends Exception {
  ...
  /**
   * Performs the appropriate disparagement act on a RepInfo object, such as setting the valid or
   * well-formed flag to <code>false</code>.
   */
