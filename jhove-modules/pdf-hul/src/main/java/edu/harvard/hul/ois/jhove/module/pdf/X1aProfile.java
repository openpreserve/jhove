...
/**
 * PDF profile checker for PDF/X-1a documents. See ISO Standard 15930-1, "Complete exchange using
 * CMYK data (PDF/X-1 and PDF/X-1a)"
 *
 * <p>This module depends on the PDF/X-1 profiler, since the PDF/X-1 specification is PDF/X-1 plus a
...
public final class X1aProfile extends XProfileBase {
  ...
  /**
   * Returns <code>true</code> if the document satisfies the profile. If <code>setX1Profile</code>
   * hasn't been called, creates a temporary X1Profile and tests against that profile first. Either
   * way, <code>X1Profile.isX1aCompliant</code> is then called to determine the X-1/a compliance
   * status.
   */
  @Override
