...
public class StreamTokenizer extends Tokenizer {
  ...
  /** Last character read. Will be returned again if _backupFlag is true. */
  ...
  @Override
  protected void initStream(Stream token) throws PdfException {
   ...
   * this, so this should never be called.
   */
  @Override
  protected void setStreamOffset(Stream token) throws PdfException {
