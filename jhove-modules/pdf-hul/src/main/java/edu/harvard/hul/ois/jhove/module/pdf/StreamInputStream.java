...
/**
 * A StreamInputStream is an InputStream which provides the bytes from a PdfStream. It reads bytes
 * from the PdfStream's underlying file starting at the beginning of the stream data and providing
 * as many bytes as are indicated by its length. No filters are applied; just the raw data is read.
 */
