 ...
 *
 * <p>An object stream can contain one or more objects, as described in Section 3.4 of the
 * PostScript manual.
 *
...
public class ObjectStream {
  ...
  /**
   * Checks the validity of the stream dictionary, and extracts information necessary for subsequent
   * reading.
   */
