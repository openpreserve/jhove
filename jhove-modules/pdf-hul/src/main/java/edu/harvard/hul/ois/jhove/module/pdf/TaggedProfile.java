...
/**
 * PDF profile checker for Tagged PDF documents. See section 9.7, "Tagged PDF", of the PDF
 * Reference, Version 1.4, for an explanation of tagged PDF.
 */
public final class TaggedProfile extends PdfProfile {
  ...
  /**
   * Returns <code>true</code> if the document satisfies the profile. We check only the
   * dictionaries, not the stream contents.
   */
  @Override
  public boolean satisfiesThisProfile() {
    try {
      ...
      PdfDictionary markInfo =
          (PdfDictionary) _module.resolveIndirectObject(docCatDict.get("MarkInfo"));
      if (markInfo == null) {
        return false;
      }
