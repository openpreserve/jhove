...
public class XmlDeclHandler implements DeclHandler {
  ...
  /**
   * Adds internal entity declarations to the entity declarations list in the form of a String[2],
   * with element 0 being the name and element 1 being the value.
   */
  @Override
  ...
  /**
   * Adds external entity declarations to the entity declarations list in the form of a String[3],
   * with element 0 being the name, element 1 the public ID, and 2 the system ID.
   */
  @Override
  ...
  /**
   * Returns list of entity declarations. Each list is an array String[2], giving the name and value
   * respectively.
   */
  ...
  /**
   * Returns list of entity declarations. Each list is an array String[3], giving the name, public
   * ID, and system ID respectively.
   */
