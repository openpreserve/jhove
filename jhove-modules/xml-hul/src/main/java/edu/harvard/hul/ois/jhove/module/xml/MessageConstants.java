...
/**
 * Enum used to externalise the XML module message Strings. Using an enum INSTANCE as a "trick" to
...
public enum MessageConstants {
  ...
  public static final JhoveMessageFactory messageFactory =
      JhoveMessages.getInstance("edu.harvard.hul.ois.jhove.module.xml.ErrorMessages");
