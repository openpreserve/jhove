...
/**
 * Class to map public DTD ID's to files which are included with this HTML module. This class is
 * used by the XML module, due to the intermodulary nature of XHTML.
 *
 * @author Gary McGath
 */
public class DTDMapper {
  ...
  /**
   * Attempts to convert a public ID to a matching DTD or Entity resource. Returns an InputStream
   * for that resource if there is a match. Otherwise returns <code>null</code>.
   *
  ...
  /**
   * Returns the XHTML version associated with the DTD's public ID. Returns <code>null</code> if it
   * isn't a known XHTML public ID.
   */
