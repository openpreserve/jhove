...
/**
 * This implementation of LexicalHandler takes care of comments, DTD's, entities and other stuff for
 * XmlModule. The caller has to make sure the LexicalHandler property is supported by the SAX
 * implementation, and set that property to this class.
 *
 * @author Gary McGath
 */
public class XmlLexicalHandler implements LexicalHandler {
  ...
  /**
   * Accumulates entity names into the entity set. This will be used for determining which entities
   * are actually used.
   *
