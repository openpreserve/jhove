...
/**
 * This class is layered under the InputSource for the XmlModule so that it can detect an XML
 * declaration and character references, which aren't reported by other API's.
 *
 * <p>This is called XmlDeclStream for historical reasons, though it's no longer limited to that
 * function.
 *
 * @author Gary McGath
 */
public class XmlDeclStream extends FilterInputStream {
   ...
   * bytes. Processes bytes as it reads them.
   */
  @Override
  ...
  /**
   * Returns the character references as a List of Integers. No sorting or elimination of duplicates
   * is done; this is just all the character references in the order they occurred.
   */
