...
public class Html3_2DocDesc extends HtmlDocDesc {
  ...
  static {
    ...
    String[] fontMarkup =
        new String[] {"tt", "i", "b", "u", "strike", "big", "small", "sub", "sup"};
    String[] phraseMarkup =
        new String[] {"em", "strong", "dfn", "code", "samp", "kbd", "var", "cite"};
    String[] specialMarkup =
        new String[] {"a", "img", "applet", "font", "basefont", "br", "script", "map"};
    ...
    String[] blockMisc =
        new String[] {
          "p", "pre", "dl", "div", "center", "blockquote", "form", "isindex", "hr", "table"
        };
    ...
    HtmlAttributeDesc valignAtt =
        new HtmlAttributeDesc(
            "valign", new String[] {"top", "middle", "bottom"}, HtmlAttributeDesc.IMPLIED);
  ...
  /**
   * Static initializers for each element. If elements are common to more than one HTML version,
   * they should be moved into the superclass. Different initializers may have different argument
   * lists.
   */
  ...
  private static void addAppletElement(HtmlAttributeDesc ialignAtt, List textContent) {
    ...
    atts.add(new HtmlAttributeDesc("width", null, HtmlAttributeDesc.REQUIRED));
    atts.add(new HtmlAttributeDesc("height", null, HtmlAttributeDesc.REQUIRED));
    atts.add(ialignAtt);
  ...
  private static void addAreaElement() {
    ...
    atts.add(
        new HtmlAttributeDesc(
            "shape", new String[] {"rect", "circle", "poly"}, HtmlAttributeDesc.REQUIRED));
  ...
  private static void addPreElement(List textContent) {
    ...
    removeStringsFromList(preContent, new String[] {"img", "big", "small", "sub", "sup", "font"});
