...
/**
 * Abstract class for common features of HTML 4.0 and 4.01 strict documents. The differences between
 * 4.0 and 4.01 are minor, so most of the code is found here.
 *
 * @author Gary McGath
 */
public abstract class Html4StrictDocDesc extends Html4DocDesc {
  ...
  protected static void addNoscriptElement(Map stSupportedElements) {
    ...
    HtmlTagDesc td = new HtmlTagDesc(name, true, false, blockContent, bigAttrs);
    stSupportedElements.put(name, td);
  }
  ...
  protected static void addOlElement(Map stSupportedElements) {
    ...
    HtmlTagDesc td = new HtmlTagDesc(name, true, true, listContent, bigAttrs);
    stSupportedElements.put(name, td);
  }
