...
public abstract class Html4DocDesc extends HtmlDocDesc {
  ...
  /**
   * Big attributes list. The dtd calls this "attrs", but here it's called lotsaAttrs to avoid
   * confusion with common local variables.
   */
  ...
  protected static void classInit4(Map stSupportedElements) {
    ...
    i18nAttrs.add(
        new HtmlAttributeDesc("id", new String[] {"ltr", "rtl"}, HtmlAttributeDesc.IMPLIED));
  ...
  protected static void addBdoElement(Map stSupportedElements) {
    ...
    atts.add(new HtmlAttributeDesc("dir", new String[] {"ltr", "rtl"}, HtmlAttributeDesc.REQUIRED));
  ...
  /**
   * Defines the MAP element. HTML 4.0 and 4.01 actually have different definitions here. 4.0 allows
   * block content or AREA elements, but not a mix of the two; 4.01 allows a mix of the two. The
   * current version of the code doesn't allow that distinction to be expressed. (There are no
  ...
  protected static void addParamElement(Map stSupportedElements) {
    ...
    atts.add(
        new HtmlAttributeDesc(
            "valuetype", new String[] {"data", "ref", "object"}, HtmlAttributeDesc.OTHER));
  ...
  protected static void addSpanElement(Map stSupportedElements) {
    ...
    HtmlTagDesc td = new HtmlTagDesc(name, true, true, inlineContent, biggerAttrs);
    stSupportedElements.put(name, td);
  }
  ...
  /**
   * Defines the TD element. The strict and transitional versions have different attribute sets, but
   * this is taken care of by the initialization of thtdAtts.
   */
  ...
  /**
   * Defines the TH element. The strict and transitional versions have different attribute sets, but
   * this is taken care of by the initialization of thtdAtts.
   */
