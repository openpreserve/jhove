...
public class ParseException extends Exception {
  ...
  /**
   * This constructor is used by the method {@code generateParseException} in the generated parser.
   * Calling this constructor generates a new object of this type with the fields {@code
   * currentToken}, {@code expectedTokenSequences}, and {@code tokenImage} set. The boolean flag
   * {@code specialConstructor} is also set to true to indicate that this constructor was used to
   * create this object. This constructor calls its super class with the empty string to force the
   * {@code toString} method of parent class {@code Throwable} to print the error message in the
   * form:
   *
   * <pre>
