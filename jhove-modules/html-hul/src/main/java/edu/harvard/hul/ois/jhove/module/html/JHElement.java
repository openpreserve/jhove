...
/**
 * Abstract superclass for the representation of portions of an HTML file. This is not the same
 * usage of "element" as the SGML definition, but refers to a parsed unit, such as an opening tag,
 * closing tag, or PCDATA.
 *
 * @author Gary McGath
 */
public abstract class JHElement {
   ...
   * Constructor.
   *
   * @param elements List of elements representing the document. May be null for a stub element
   *     which is implied rather than being generated by the parser.
   */
  ...
  /**
   * Extracts entities from a text string and returns them as a List of Strings. If there are no
   * entities, returns an empty List.
   */
