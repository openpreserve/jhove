...
public class HtmlAttributeDesc {
  ...
  public static final int REQUIRED = 1, // #REQUIRED
      CURRENT = 2, // #CURRENT
      CONREF = 3, // #CONREF
      IMPLIED = 4, // #IMPLIED
   ...
   * @param permittedValues Specific values allowed for the parameter. If null, then any CDATA value
   *     is allowed.
   * @param kind The kind of parameter. Must be REQUIRED, CURRENT, CONREF, or IMPLIED.
   */
  ...
  /** Returns <code>true</code> if this tag's name matches the parameter. */
  public boolean nameMatches(String name) {
    return _name.equals(name);
  }

  /** Returns <code>true</code> if the parameter is a permissible value for the attribute. */
  public boolean valueOK(String name, String value) {
    if (_permittedValues == null) {
      ...
      return _permittedValues.length == 1 && _permittedValues[0].equals(name);
    } else {
