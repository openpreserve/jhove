...
/**
 * Abstract class for common features of HTML 4.0 and 4.01 transitional and frameset documents. The
 * differences between 4.0 and 4.01 are minor, as are the differences between transitional and
 * frameset so most of the code is found here.
 *
 * @author Gary McGath
 */
public abstract class Html4TFDocDesc extends Html4DocDesc {
  ...
  /**
   * Code which is called from the static initializer of the subclasses. Note that this is called
   * before the class is instantiated, and may reference only static fields and subroutines.
   */
  ...
  protected static void addAreaElement(Map stSupportedElements, HtmlAttributeDesc shapeAtt) {
    ...
    atts.add(new HtmlAttributeDesc("nohref", new String[] {"nohref"}, HtmlAttributeDesc.IMPLIED));
  ...
  protected static void addBrElement(Map stSupportedElements, List coreAttrs) {
    ...
    atts.add(
        new HtmlAttributeDesc(
            "clear", new String[] {"left", "all", "right", "none"}, HtmlAttributeDesc.OTHER));
    HtmlTagDesc td = new HtmlTagDesc(name, true, false, null, atts);
    stSupportedElements.put(name, td);
  }
  ...
  protected static void addButtonElement(Map stSupportedElements) {
    ...
    atts.add(
        new HtmlAttributeDesc(
            "type", new String[] {"button", "submit", "reset"}, HtmlAttributeDesc.OTHER));
  ...
  protected static void addCaptionElement(
      Map stSupportedElements, List inlineContent, HtmlAttributeDesc valignAtt) {
    String name = "caption";
    List atts = new ArrayList(bigAttrs.size() + 1);
    atts.add(
        new HtmlAttributeDesc(
            "align", new String[] {"top", "bottom", "left", "right"}, HtmlAttributeDesc.IMPLIED));
  ...
  protected static void addFrameElement(Map stSupportedElements) {
    ...
    atts.add(
        new HtmlAttributeDesc(
            "scrolling", new String[] {"yes", "no", "auto"}, HtmlAttributeDesc.OTHER));
    HtmlTagDesc td = new HtmlTagDesc(name, true, false, null, atts);
    stSupportedElements.put(name, td);
  }
  ...
  protected static void addFramesetElement(Map stSupportedElements) {
    ...
    addStringsToList(new String[] {"frameset", "frame", "noframes"}, content);
  ...
  protected static void addHrElement(Map stSupportedElements) {
    ...
    atts.add(
        new HtmlAttributeDesc(
            "align", new String[] {"left", "center", "right"}, HtmlAttributeDesc.IMPLIED));
  ...
  protected static void addLegendElement(Map stSupportedElements) {
    ...
    atts.add(
        new HtmlAttributeDesc(
            "align", new String[] {"top", "left", "bottom", "right"}, HtmlAttributeDesc.IMPLIED));
    HtmlTagDesc td = new HtmlTagDesc(name, true, true, inlineContent, atts);
    stSupportedElements.put(name, td);
  }
  ...
  protected static void addNoframesElement(Map stSupportedElements, int version) {
    ...
    List content;
    if (version == HtmlModule.HTML_4_01_FRAMESET || version == HtmlModule.HTML_4_0_FRAMESET) {
  ...
  protected static void addPElement(Map stSupportedElements) {
    ...
    atts.add(
        new HtmlAttributeDesc(
            ...
            new String[] {"left", "center", "right", "justify"},
            HtmlAttributeDesc.IMPLIED));
    HtmlTagDesc td = new HtmlTagDesc(name, true, false, inlineContent, atts);
    stSupportedElements.put(name, td);
  }
  ...
  protected static void addPreElement(Map stSupportedElements) {
    ...
    removeStringsFromList(preContent, new String[] {"img", "object", "big", "small", "sub", "sup"});
    List atts = new ArrayList(bigAttrs.size() + 1);
    atts.addAll(bigAttrs);
    addSimpleAttribute(atts, "width");
  ...
  protected static void addTableElement(Map stSupportedElements) {
    ...
    HtmlTagDesc td = new HtmlTagDesc(name, true, true, contentSequence, contentArray, atts);
    stSupportedElements.put(name, td);
  }
