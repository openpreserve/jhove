...
/**
 * Caution: Changes made by hand to fix bugs. Be sure to reenter these fixes if the file is
 * regenerated.
 */
...
public class ParseHtml implements ParseHtmlConstants {
  ...
  public final List HtmlDoc() throws ParseException {
  ...
  public final JHElement Element(List elements) {
    JHElement elem;
    try {
      if (jj_2_1(2)) {
        elem = Doctype();
      ...
      for (; ; ) {
        ...
        errText
            ...
            .append(tok.image)
            .append("\", Line = ")
            .append(tok.beginLine)
            .append(", Column = ")
            .append(tok.beginColumn);
      ...
      {
        if (true)
          return new JHErrorElement(
              elements, MessageConstants.HTML_HUL_2, errText.toString(), true);
      }
    }
    {
      if (true) return elem;
  ...
  public final JHOpenTag OpenTag() throws ParseException {
    ...
    if ("/".equals(slasher)) {
      ...
      {
        if (true)
          return new JHOpenTag(elements, name.image, attrs, name.beginLine, name.beginColumn);
      }
    }
    throw new Error("Missing return statement in function");
  }

  public final JHXmlDecl XMLDecl() throws ParseException {
    List attrs = new LinkedList();
    jj_consume_token(LABRACKET);
  ...
  public final JHCloseTag CloseTag() throws ParseException {
    Token name;
    jj_consume_token(LABRACKET);
    ...
    jj_consume_token(RABRACKET);
    {
      if (true) return new JHCloseTag(elements, name.image, name.beginLine, name.beginColumn);
    }
    throw new Error("Missing return statement in function");
  }

  public final JHPCData PCData() throws ParseException {
  ...
  public final JHDoctype Doctype() throws ParseException {
  ...
  public final void DoctypeItem(List dtElements) throws ParseException {
    Token tok = getToken(1);
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case NAKEDDTITEM:
  ...
  public final String AttrVal() throws ParseException {
    Token tok = getToken(1);
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case NAKEDVALUE:
  ...
  public final void Attribute(List attrs) throws ParseException {
    JHAttribute attval;
    Token name;
    Token namespace;
    String val;
    if (jj_2_5(2)) {
      ...
      val = AttrVal();
      attval = new JHAttribute(name.image, namespace.image, val, name.beginLine, name.beginColumn);
      attrs.add(attval);
    } else if (jj_2_6(2)) {
      namespace = Name();
      jj_consume_token(COLON);
      name = Name();
      attval = new JHAttribute(name.image, namespace.image, null, name.beginLine, name.beginColumn);
      attrs.add(attval);
    } else if (jj_2_7(2)) {
      name = Name();
      jj_consume_token(EQUALS);
      val = AttrVal();
      attval = new JHAttribute(name.image, null, val, name.beginLine, name.beginColumn);
      attrs.add(attval);
    } else if (jj_2_8(2)) {
      name = Name();
      attval = new JHAttribute(name.image, null, null, name.beginLine, name.beginColumn);
      attrs.add(attval);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  public final String TagCloser() throws ParseException {
    Token tok = getToken(1);
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case SLASH:
        jj_consume_token(SLASH);
  ...
  private static void jj_la1_0() {
    jj_la1_0 =
        new int[] {
          0x16, 0x10, 0x20, 0x20, 0x18000, 0x18000, 0x180, 0x2800,
        };
  }
