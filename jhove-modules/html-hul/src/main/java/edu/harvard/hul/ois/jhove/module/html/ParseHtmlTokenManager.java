...
public class ParseHtmlTokenManager implements ParseHtmlConstants {
  ...
  public static final String[] jjstrLiteralImages = {
    "", "\74\41", "\74", null, null, null, null, null, null, null, "\77", "\57", "\72", "\76", null,
  ...
  public static final int[] jjnewLexState = {
    -1, 4, 2, 1, 0, -1, 3, 2, 2, 2, -1, -1, -1, 0, 5, -1, -1, -1, -1, -1, -1, -1, 6, 7, -1, 0, 6,
  };
    ...
    for (; ; ) {
      ...
      if (curChar < 64) {
        long l = 1L << curChar;
        {
          switch (jjstateSet[--i]) {
            case 0:
              if ((0xeffffffeffffc9ffL & l) != 0L) kind = 3;
              break;
            default:
              break;
          }
        ...
        long l2 = 1L << (curChar & 077);
        {
          switch (jjstateSet[--i]) {
            case 0:
              if ((jjbitVec0[i2] & l2) != 0L && kind > 3) kind = 3;
              break;
            default:
              break;
          }
  ...
  private final int jjMoveStringLiteralDfa6_4(long old0, long active0) {
    ...
    switch (curChar) {
      case 69:
      case 101:
        if ((active0 & 0x4000L) != 0L) return jjStopAtPos(6, 14);
        break;
      default:
        return 7;
    }
          ...
          switch (jjstateSet[--i]) {
            case 1:
              if ((0xbffffffaffffc9ffL & l) != 0L) {
                if (kind > 15) kind = 15;
                jjCheckNAdd(0);
              } else if (curChar == 34) jjCheckNAddTwoStates(2, 3);
              break;
            case 0:
              if ((0xbffffffaffffc9ffL & l) == 0L) break;
              if (kind > 15) kind = 15;
              jjCheckNAdd(0);
              break;
            case 2:
              if ((0xfffffffbffffcbffL & l) != 0L) jjCheckNAddTwoStates(2, 3);
              break;
            case 3:
              if (curChar == 34 && kind > 16) kind = 16;
              break;
            default:
              break;
          }
        ...
        do {
          switch (jjstateSet[--i]) {
            case 1:
              ...
              break;
            case 0:
              if ((0x9fffeffaffffc9ffL & l) == 0L) break;
              if (kind > 7) kind = 7;
              jjCheckNAdd(0);
              break;
            case 2:
              if ((0xfffffffbffffffffL & l) != 0L) jjCheckNAddTwoStates(2, 3);
              break;
            case 3:
        ...
        do {
          switch (jjstateSet[--i]) {
            ...
            case 2:
              ...
              break;
            case 5:
              if ((jjbitVec0[i2] & l2) != 0L) jjAddStates(2, 3);
              break;
            default:
              break;
          }
  ...
  private final void ReInitRounds() {
    int i;
    jjround = 0x80000001;
    for (i = 7; i-- > 0; ) jjrounds[i] = 0x80000000;
  }
  ...
  public void SwitchTo(int lexState) {
    if (lexState >= 8 || lexState < 0)
      throw new TokenMgrError(
          MessageConstants.HTML_HUL_21.getMessage() + lexState,
  ...
  protected Token jjFillToken() {
    ...
    if (jjmatchedPos < 0) {
      if (image == null) t.image = "";
      else t.image = image.toString();
