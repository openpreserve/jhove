...
/**
 * Abstract class for the HTML 4.0 Transitional and Frameset document types. These are identical
 * except for one element apiece, so nearly all the code is here or in its superclasses.
 *
 * @author Gary McGath
 */
public abstract class Html4_0TFDocDesc extends Html4TFDocDesc {
  ...
  protected static void classInit4(Map stSupportedElements, int version) {
    ...
    if (version == HtmlModule.HTML_4_0_FRAMESET) {
