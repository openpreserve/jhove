...
public class Html4_0StrictDocDesc extends Html4StrictDocDesc {
  ...
  /**
   * Constructor. Most of the initialization work is done in a static code block rather than in the
   * constructor, so as to minimize overhead on multiple invocations.
   */
