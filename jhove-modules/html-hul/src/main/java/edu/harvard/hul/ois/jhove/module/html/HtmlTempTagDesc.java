...
/**
 * Subclass of HtmlTagDesc for temporary tags. This doesn't add any functionality to the superclass,
 * but serves as a marker class.
 *
 * @author Gary McGath
 */
public class HtmlTempTagDesc extends HtmlTagDesc {
  ...
  /** Reports whether this is a temporary tag descriptor. Returns <code>true</code>. */
  @Override
   ...
   * Since we know nothing about this element, no meaningful answer is possible. Return <code>true
   * </code> just to minimize the number of extra error messages.
   */
  @Override
