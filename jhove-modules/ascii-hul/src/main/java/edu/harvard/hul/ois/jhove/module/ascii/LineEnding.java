...
public enum LineEnding {
   ...
   *
   * @param lastChar the last character read from stream
   * @param prevChar the previous character to the lastChar
   * @return the appropriate line ending type, or null if the character's aren't a line ending
   *     combination
   */
  public static LineEnding fromControlChars(
      final ControlChar lastChar, final ControlChar prevChar) {
