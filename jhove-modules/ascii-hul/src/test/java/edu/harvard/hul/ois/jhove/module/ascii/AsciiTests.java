...
public class AsciiTests {
  private static final String asciiResourcePath = TestUtils.MODULE_RESOURCE_BASE + "ascii/";

  private static final String nullsOnly = asciiResourcePath + "nulls-only.txt";
  private static final String allCtrls = asciiResourcePath + "all-ctrls.txt";
  private static final String allGraphics = asciiResourcePath + "all-graphics.txt";
  private static final String allAscii = asciiResourcePath + "all-ascii.txt";
  private static final String allAsciiInv = asciiResourcePath + "all-ascii-and-invalid.txt";
  ...
  public final void testCharOutOfRange() throws URISyntaxException {
    TestUtils.testValidateResource(
        ...
        RepInfo.FALSE,
        RepInfo.FALSE,
        MessageConstants.ASCII_HUL_1.getMessage());
  }
  ...
  public final void testPrintable() throws URISyntaxException {
    TestUtils.testValidateResource(
        ...
        RepInfo.TRUE,
        RepInfo.TRUE,
        MessageConstants.ASCII_HUL_3.getMessage(),
        false);
  }
  ...
  private static final void testAllAsciiCtrlCharsDetected(final RepInfo info) {
    Property ctrlCharProp = info.getProperty("ASCIIMetadata").getByName(ControlChar.PROP_NAME);
    ...
    Integer asciiCtrlMinusCrLf = Integer.valueOf(ControlChar.ASCII.size() - 2);
    assertTrue(
        String.format("Only %d characters found, expecting %d", mnemonicsCount, asciiCtrlMinusCrLf),
