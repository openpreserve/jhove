...
public class GifStrings {
  ...
  public static final String[] COLOR_TABLE_SORT_FLAG = {
    "Not ordered", "Ordered by decreasing importance"
  };

  /**
   * GIF Capabilities Enquiry string: way in which the graphic is to be treated after being
   * displayed
   */
  public static final String[] GCE_DISPOSAL_METHOD = {
    "No disposal specified", "Do not dispose", "Restore to background color", "Restore to previous"
  };

  /** GIF Capabilities Enquiry string: user input expected or not */
  public static final String[] GCE_USER_INPUT_FLAG = {
    "User input not expected", "User input expected"
  };

  /** GIF Capabilities Enquiry string: transparency index given or not */
  public static final String[] GCE_TRANSPARENCY_FLAG = {
    "Transparent index is not given", "Transparent index given"
  };

  /** Local color table present in image or not */
  public static final String[] LOCAL_COLOR_TABLE_FLAG = {
    "No local color table; use global table if available", "Local color table follows"
  };
