...
public class Utf8BlockTests {
  ...
  /**
   * This test makes sure that the code blocks are declared in monotonically increasing order
   * without overlap, each one has a positive range, and names aren't duplicated.
   */
  @Test
