  ...
  public boolean readBox() throws IOException {
    ...
    if (box instanceof FragmentListBox) {
      ...
      if (fragList != null) {
        ...
        FragmentInputStream fragStream = new FragmentInputStream(fragList, _raf, bufSize);
        ...
        long len = _boxHeader.getLength() == 0 ? 0 : _boxHeader.getDataLength();
        ContCodestream ccs = new ContCodestream(_module, dfstrm, len);
      ...
      _repInfo.setMessage(new ErrorMessage(MessageConstants.JPEG2000_HUL_24, _module.getFilePos()));
