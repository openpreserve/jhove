...
/**
 * This is a subclass of MarkerSegment for Markers. Markers are those elements of a codestream which
 * have no parameters. It can be subclassed for specific Markers, or used directly to provide
 * default behavior.
 *
 * @author Gary McGath
 */
