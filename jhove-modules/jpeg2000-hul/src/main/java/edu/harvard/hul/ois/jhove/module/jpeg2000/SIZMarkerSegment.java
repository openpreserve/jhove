...
/**
 * Class for the SIZ marker segment. This is a mandatory marker in the main header, and provides
 * information about the uncompressed image such as the width and height of the reference grid, the
 * width and height of the tiles, the number of components, component bit depth, and the separation
 * of component samples with respect to the reference grid.
 *
 * @author Gary McGath
 */
public class SIZMarkerSegment extends MarkerSegment {
  ...
  /**
   * Process the marker segment. The DataInputStream will be at the point of having read the marker
  ...
  protected boolean process(int bytesToEat) throws IOException {
    ...
    plist.add(new Property("Capabilities", PropertyType.INTEGER, new Integer(rsiz)));
    plist.add(new Property("XSize", PropertyType.INTEGER, new Integer(xsiz)));
    plist.add(new Property("YSize", PropertyType.INTEGER, new Integer(ysiz)));
    plist.add(new Property("XOSize", PropertyType.INTEGER, new Integer(xosiz)));
    plist.add(new Property("YOSize", PropertyType.INTEGER, new Integer(yosiz)));
    plist.add(new Property("XTSize", PropertyType.INTEGER, new Integer(xtsiz)));
    plist.add(new Property("YTSize", PropertyType.INTEGER, new Integer(ytsiz)));
    plist.add(new Property("XTOSize", PropertyType.INTEGER, new Integer(xtosiz)));
    plist.add(new Property("YTOSize", PropertyType.INTEGER, new Integer(ytosiz)));
    plist.add(new Property("CSize", PropertyType.INTEGER, new Integer(csiz)));
    plist.add(new Property("SSize", PropertyType.INTEGER, PropertyArity.ARRAY, ssiz));
    plist.add(new Property("XRSize", PropertyType.INTEGER, PropertyArity.ARRAY, xrsiz));
    plist.add(new Property("YRSize", PropertyType.INTEGER, PropertyArity.ARRAY, yrsiz));
    _cs.setSIZProperty(
        new Property("ImageAndTileSize", PropertyType.PROPERTY, PropertyArity.LIST, plist));
