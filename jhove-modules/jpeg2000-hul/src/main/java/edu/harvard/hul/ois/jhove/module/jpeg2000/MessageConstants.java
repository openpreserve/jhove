...
/**
 * Enum used to externalise the JPEG 2000 modules message Strings. Using an enum INSTANCE as a
 * "trick" to ensure a single instance of the class. String constants should be prefixed according
 * to their use in the module:
 *
 * <ul>
 ...
 *   <li>ENTITY_NAME: the name of the JPEG 2000 entity causing the prohlem, e.g. BOX, FILE_TYPE_BOX,
 *       COC_MARKER, etc.
 *   <li>PROBLEM_LOCATION: the location or component inside the entity, e.g. POSITION, SIZE, TYPE,
 *       NUMBER_OF_ENTRIES, etc.
 *   <li>PROBLEM_TYPE: a short indicator of the problem type, e.g. MISSING, INVALID, EMPTY, OVERRUN,
 *       UNDERRUN, etc.
 * </ol>
 *
 ...
 *
 * @author <a href="mailto:martin@hoppenheit.info">Martin Hoppenheit</a> <a
 *     href="https://github.com/marhop">marhop AT github</a>
...
public enum MessageConstants {
  ...
  public static final JhoveMessageFactory messageFactory =
      JhoveMessages.getInstance("edu.harvard.hul.ois.jhove.module.jpeg2000.ErrorMessages");
  /** Warning messages */
  // None yet.
