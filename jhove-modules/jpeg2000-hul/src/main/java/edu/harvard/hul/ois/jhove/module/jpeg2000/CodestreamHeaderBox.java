...
/**
 * Codestream Header box. This is similar to a JP2HeaderBox, and has many of the same subboxes, but
 * applies to a single codestream.
 *
 * <p>See ISO/IEC FCD15444-2: 2000, L.9.3
 *
 * @author Gary McGath
 */
  ...
  public boolean readBox() throws IOException {
    ...
    while (hasNext()) {
      ...
      if (state == 0 && box instanceof LabelBox) {
        ...
        curCodestream.setLabelProperty(
            new Property("Label", PropertyType.STRING, ((LabelBox) box).getLabel()));
      ...
      // is the image header.
        ...
        if (box instanceof ImageHeaderBox) {
          ...
          _repInfo.setMessage(
              new ErrorMessage(MessageConstants.JPEG2000_HUL_7, _module.getFilePos()));
