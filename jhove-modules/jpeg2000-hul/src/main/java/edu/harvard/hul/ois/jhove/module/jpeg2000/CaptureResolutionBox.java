...
public class CaptureResolutionBox extends JP2Box {
  ...
  public boolean readBox() throws IOException {
    ...
    topProps[0] = ResolutionBox.makeResolutionProperty("HorizResolution", hrcNum, hrcDenom, hrcExp);
    topProps[1] = ResolutionBox.makeResolutionProperty("VertResolution", vrcNum, vrcDenom, vrcExp);
    _module.addProperty(
        new Property("CaptureResolution", PropertyType.PROPERTY, PropertyArity.ARRAY, topProps));
