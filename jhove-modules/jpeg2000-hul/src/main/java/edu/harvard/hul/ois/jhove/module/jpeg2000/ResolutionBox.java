...
public class ResolutionBox extends JP2Box {
  ...
  public static Property makeResolutionProperty(String name, int num, int denom, int exp) {
    ...
    resList.add(new Property("Numerator", PropertyType.INTEGER, new Integer(num)));
    resList.add(new Property("Denominator", PropertyType.INTEGER, new Integer(denom)));
    resList.add(new Property("Exponent", PropertyType.INTEGER, new Integer(exp)));
  ...
  public static Rational convertToRational(int num, int denom, int exp) {
    ...
    return new Rational((int) (num * Math.pow(POWER, exp)), denom * FROM_M_TO_CM);
  }
