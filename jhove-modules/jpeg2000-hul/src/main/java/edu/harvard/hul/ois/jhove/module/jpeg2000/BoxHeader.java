...
public class BoxHeader {
  ...
  /**
   * Returns the box length, which includes the length and type fields. If the value returned is 0,
   * the length of the box is all the remaining data to the end of the file.
   */
  ...
  /**
   * Returns the length of the header. This number is equal to the number of bytes that have been
   * read by <code>readHeader()</code>.
   */
  ...
  /**
   * Returns the number of bytes in the Box, not including the header. This is equivalent to <code>
   * getLength() - getHeaderLength()</code>. If <code>getLength()</code> would return 0, this value
   * is meaningless.
   */
