...
public class UUIDInfoBox extends JP2Box {
  ...
  public boolean readBox() throws IOException {
    ...
    if (sizeLeft != 0) {
      ...
      _repInfo.setMessage(new ErrorMessage(MessageConstants.JPEG2000_HUL_56, _module.getFilePos()));
    ...
    _module.addUUIDInfo(
        new Property("UUIDInfo", PropertyType.PROPERTY, PropertyArity.LIST, propList));
    finalizeBytesRead();
    return true;
  }
  ...
  /**
   * Sets the UUID list. The argument is an array of byte arrays of length 16, or schematically:
   * <code>byte[][16]</code>.
   */
  protected void setUUIDList(byte[][] uuids) {
    ...
    _uuidListProp = new Property("UUIDInfo", PropertyType.PROPERTY, PropertyArity.LIST, propList);
  }
