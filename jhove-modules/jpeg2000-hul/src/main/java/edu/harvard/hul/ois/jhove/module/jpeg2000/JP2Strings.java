...
public final class JP2Strings {
  ...
  public static final String methodStr[] = {
    "", "Enumerated Colorspace", "Restricted ICC Profile", "Any ICC Method", "Vendor Color Method"
  };

  /**
   * Strings for values of enumCS in the color specification box. Only values 16-17 are recognized
   * by JP2.
   */
  public static final String enumCSStr[] = {
    "Bilevel (1 = black)",
    "YCbCr (1)",
    "",
    "YCbCr (2)",
  ...
  public static final String opacityTypeStr[] = {
  ...
  /**
   * Strings for the number type value in the Number List box. Types must be normalized by shifting
   * the high byte right 24 bits before indexing.
   */
  public static final String numberListTypeStr[] = {
    "Rendered result", "Codestream number", "Compositing layer", "Numbered entity"
  };

  /** Strings for types in the Digital Signature Box. */
  public static final String digitalSigTypeStr[] = {
    "MD5 checksum",
    "SHA-1 checksum",
    "DSA signature",
  ...
  public static final String inCodestreamStr[] = {
  ...
  public static final String ctypStr[] = {
    "Color image data", "Opacity", "Premultiplied opacity", "Not specified" // 2^16 - 1
  };
  ...
  /**
   * Strings for the approx field of the color specification box, indexed by approxIdx. A zero value
   * will be reported as an Integer property of 0.
   */
  public static final String approxStr[] = {
  ...
  /** Private constructor, to make sure the class isn't inadvertently initiated. */
  private JP2Strings() {}
}
