...
/**
 * Fragment List Box (JPX). Subbox of Fragment Table box or Cross-Reference box. See L.9.6.1 in
 * ISO/IEC FCD15444-2:2000.
 *
 * @author Gary McGath
 */
public class FragmentListBox extends JP2Box {
   ...
   *
   * @param parent parent superbox of this box. The parent may be a FragmentTableBox or a
   *     CrossReferenceBox.
   */
  ...
  public boolean readBox() throws IOException {
    ...
    if (_boxHeader.getLength() != 0 && len != 14 * nFrags + 2) {
      _repInfo.setMessage(new ErrorMessage(MessageConstants.JPEG2000_HUL_23, _module.getFilePos()));
    ...
    for (int i = 0; i < nFrags; i++) {
      ...
      if (dataRef != 0) {
        ...
        _repInfo.setMessage(
            new InfoMessage(
                MessageConstants.INF_FRAGMENT_LIST_BOX_EXT_FILE_REFERENCE, _module.getFilePos()));
  ...
  /**
   * Returns the fragment list. If there are external references to fragments, returns null; in this
   * case, a warning message has been added to the RepInfo object.
   */
