...
public class TilePart {
  ...
  public Property makeProperty() {
    Property indexProp = new Property("Index", PropertyType.INTEGER, new Integer(_index));
    Property lengthProp = new Property("Length", PropertyType.LONG, new Long(_length));
    List propList = new ArrayList(2);
    propList.add(indexProp);
    propList.add(lengthProp);
    return new Property("TilePart", PropertyType.PROPERTY, PropertyArity.LIST, propList);
  }
}
