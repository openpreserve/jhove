...
/**
 * Class for the QCD (Quantization default) marker segment. This comes either in the main header or
 * after an SOT.
 *
 * @author Gary McGath
 */
public class QCDMarkerSegment extends MarkerSegment {
  ...
  protected boolean process(int bytesToEat) throws IOException {
    ...
    switch (sqcdLow) {
      ...
      default:
        _repInfo.setMessage(new ErrorMessage(MessageConstants.JPEG2000_HUL_48));
    ...
    cs.setQCDProperty(
        new Property("QuantizationDefault", PropertyType.PROPERTY, PropertyArity.LIST, propList));
    return true;
  }
}
