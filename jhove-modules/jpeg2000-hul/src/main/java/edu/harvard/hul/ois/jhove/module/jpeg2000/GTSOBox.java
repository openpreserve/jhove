...
/**
 * Graphics Technology Standard Output Box. This box holds an ICC color profile.
 *
 * <p>See ISO/IEC FCD15444-2: 2000, L.9.15.1
 *
 * @author Gary McGath
 */
public class GTSOBox extends JP2Box {
  ...
  public boolean readBox() throws IOException {
    ...
    Property sizeProp = new Property("ProfileLength", PropertyType.LONG, new Long(propSize));
    _module.addProperty(
        new Property("GraphicsTechnologyStandardOutput", PropertyType.PROPERTY, sizeProp));
