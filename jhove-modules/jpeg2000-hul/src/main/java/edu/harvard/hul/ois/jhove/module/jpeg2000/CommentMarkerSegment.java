...
public class CommentMarkerSegment extends MarkerSegment {
  ...
  protected boolean process(int bytesToEat) throws IOException {
    ...
    switch (rcom) {
      case 0:
        // Binary comment
        prop = new Property("Comment", PropertyType.BYTE, PropertyArity.ARRAY, byteBuf);
        break;

      case 1:
        // ISO Latin comment
        prop = new Property("Comment", PropertyType.STRING, new String(byteBuf));
        break;

      default:
        _repInfo.setMessage((new ErrorMessage(MessageConstants.JPEG2000_HUL_13)));
