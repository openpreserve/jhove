...
/**
 * Class for the PPM (Packed packet headers, main header) marker segment. I'm assuming for the
 * present that the full details of packet headers is getting deeper into the bits than we want, so
 * it just checks some basic information. There can be multiple PPM marker segments.
 *
 * @author Gary McGath
 */
