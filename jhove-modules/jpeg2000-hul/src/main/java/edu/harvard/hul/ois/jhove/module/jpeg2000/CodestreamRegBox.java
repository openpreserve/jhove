...
public class CodestreamRegBox extends JP2Box {
   ...
   *
   * @param parent parent superbox of this box (must be a ComposLayerHdrBox)
   */
  ...
  public boolean readBox() throws IOException {
    ...
    for (int i = 0; i < nStreams; i++) {
      ...
      streamsProp[i] =
          new Property("Codestreams", PropertyType.PROPERTY, PropertyArity.ARRAY, csProp);
    }
    ((ComposLayerHdrBox) _parentBox)
        .addCodestreamReg(
            new Property(
                "CodestreamRegistration", PropertyType.PROPERTY, PropertyArity.ARRAY, streamsProp));
    return true;
  }
