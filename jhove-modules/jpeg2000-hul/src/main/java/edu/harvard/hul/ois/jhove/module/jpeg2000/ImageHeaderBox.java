...
public class ImageHeaderBox extends JP2Box {
  ...
  public boolean readBox() throws IOException {
    ...
    if (_boxHeader.getLength() != 22) {
      _repInfo.setMessage(new ErrorMessage(MessageConstants.JPEG2000_HUL_27, _module.getFilePos()));
    ...
    if (nc == 0) {
      _repInfo.setMessage(new ErrorMessage(MessageConstants.JPEG2000_HUL_25, _module.getFilePos()));
      return false;
    }
    ...
    _module.addProperty(
        new Property("ColorspaceUnknown", PropertyType.BOOLEAN, Boolean.valueOf(unk != 0)));
    // Skip unsigned byte
