...
/**
 * Abstract superclass for Codestream and Tile classes. Many marker segments can apply either to the
 * codestream as a whole or to specific tiles; this class merges those features in a single place.
 *
 * @author Gary McGath
 */
public abstract class MainOrTile {
  ...
  /**
   * Array of components. This is created when the SIZ marker segment reports the number of
   * components.
   */
  ...
  /**
   * Sets the number of components. As a side effect, creates the compoments array. This should be
   * called from the SIZMarkerSegment class, and in a valid file will precede the setting of any
   * components.
   */
