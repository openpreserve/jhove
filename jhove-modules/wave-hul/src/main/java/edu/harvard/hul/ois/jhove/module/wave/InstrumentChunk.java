 ...
 * Similar to the Sample chunk or the AIFF Instrument chunk, but simpler than either.
 *
 * @author Gary McGath
 */
public class InstrumentChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    propArr[0] = new Property("UnshiftedNote", PropertyType.INTEGER, new Integer(unshiftedNote));
    propArr[1] = new Property("FineTune", PropertyType.INTEGER, new Integer(fineTune));
    propArr[2] = new Property("Gain", PropertyType.INTEGER, new Integer(gain));
    propArr[3] = new Property("LowNote", PropertyType.INTEGER, new Integer(lowNote));
    propArr[4] = new Property("HighNote", PropertyType.INTEGER, new Integer(highNote));
    propArr[5] = new Property("LowVelocity", PropertyType.INTEGER, new Integer(lowVelocity));
    propArr[6] = new Property("HighVelocity", PropertyType.INTEGER, new Integer(highVelocity));
    module.addWaveProperty(
        new Property("Instrument", PropertyType.PROPERTY, PropertyArity.ARRAY, propArr));
    return true;
  }
}
