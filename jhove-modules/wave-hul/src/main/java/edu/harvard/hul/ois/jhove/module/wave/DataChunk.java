 ...
 *
 * <p>Data Chunks may occur either at the top level (i.e., under the RIFF chunk) or under a data
 * list chunk. There can be only one top-level Data Chunk.
 *
 * @author Gary McGath
 */
public class DataChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    Property lenProp = new Property("DataLength", PropertyType.LONG, new Long(bytesLeft));
