...
/**
 * Implementation of the WAVE Sample (or Sampler) Chunk, which gives information about a MIDI
 * sample.
 *
 * @author Gary McGath
 */
public class SampleChunk extends Chunk {
   ...
   *
   * <p>It isn't clear whether multiple Sample chunks are allowed (representing different sound
   * samples for different notes or note ranges). This module assumes they are, so it constructs a
   * Samples property, consisting of a list of Sample properties.
   *
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    smpteArr[0] = new Property("Hour", PropertyType.INTEGER, new Integer(sampleOffsetHour));
    smpteArr[1] = new Property("Minute", PropertyType.INTEGER, new Integer(sampleOffsetMinute));
    smpteArr[2] = new Property("Second", PropertyType.INTEGER, new Integer(sampleOffsetSecond));
    smpteArr[3] = new Property("Frames", PropertyType.INTEGER, new Integer(sampleOffsetFrames));
    ...
    for (int i = 0; i < nLoops; i++) {
      ...
      lp[0] = new Property("CuePointID", PropertyType.LONG, new Long(cuePoint));
      lp[1] = new Property("Type", PropertyType.INTEGER, new Integer(type));
      lp[2] = new Property("Start", PropertyType.INTEGER, new Integer(start));
      lp[3] = new Property("End", PropertyType.INTEGER, new Integer(end));
      lp[4] = new Property("Fraction", PropertyType.LONG, new Long(fraction));
      lp[5] = new Property("PlayCount", PropertyType.LONG, new Long(playCount));
      loopProps[i] = new Property("Loop", PropertyType.PROPERTY, PropertyArity.ARRAY, lp);
    }

    Property[] propArr = new Property[9];
    propArr[0] = new Property("Manufacturer", PropertyType.LONG, new Long(manufacturer));
    propArr[1] = new Property("Product", PropertyType.LONG, new Long(product));
    propArr[2] = new Property("SamplePeriod", PropertyType.LONG, new Long(samplePeriod));
    propArr[3] = new Property("UnityNote", PropertyType.LONG, new Long(unityNote));
    propArr[4] = new Property("PitchFraction", PropertyType.LONG, new Long(pitchFraction));
    propArr[5] = new Property("SMPTEFormat", PropertyType.LONG, new Long(smpteFormat));
    propArr[6] = new Property("SMPTEOffset", PropertyType.PROPERTY, PropertyArity.ARRAY, smpteArr);
    propArr[7] = new Property("Loops", PropertyType.PROPERTY, PropertyArity.ARRAY, loopProps);
    propArr[8] = new Property("ExtraDataBytes", PropertyType.LONG, new Long(extraBytes));
    module.addSample(new Property("Sample", PropertyType.PROPERTY, PropertyArity.ARRAY, propArr));
