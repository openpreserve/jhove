...
public abstract class SimpleTextChunk extends Chunk {
  ...
  protected Property readTextProp(WaveModule module, String propName) throws IOException {
    ...
    propArr[0] = new Property("CuePointID", PropertyType.LONG, new Long(cueID));
    propArr[1] = new Property("Text", PropertyType.STRING, txt);
    return new Property(propName, PropertyType.PROPERTY, PropertyArity.ARRAY, propArr);
  }
}
