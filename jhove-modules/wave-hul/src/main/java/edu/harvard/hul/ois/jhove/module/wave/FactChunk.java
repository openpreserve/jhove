 ...
 *
 * <p>The Fact chunk contains information specific to the compression scheme.
 *
 * @author Gary McGath
 */
public class FactChunk extends Chunk {

  private static final int BASE_CHUNK_SIZE = 4;
   ...
   */
  public FactChunk(ModuleBase module, ChunkHeader hdr, DataInputStream dstrm) {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    if (module.hasExtendedDataSizes() && sampleLength == WaveModule.LOOKUP_EXTENDED_DATA_SIZE) {
    ...
    Property sizeProp = new Property("Size", PropertyType.LONG, Long.valueOf(chunkSize));
    module.addWaveProperty(new Property("Fact", PropertyType.PROPERTY, sizeProp));
