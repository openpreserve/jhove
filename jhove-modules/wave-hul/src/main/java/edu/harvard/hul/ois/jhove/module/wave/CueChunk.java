...
public class CueChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    for (int i = 0; i < nPoints; i++) {
      ...
      cueProps[0] = new Property("ID", PropertyType.LONG, Long.valueOf(dwIdent));
      cueProps[1] = new Property("Position", PropertyType.LONG, Long.valueOf(dwPos));
      cueProps[2] = new Property("DataChunkID", PropertyType.STRING, fccID);
      cueProps[3] = new Property("ChunkStart", PropertyType.LONG, Long.valueOf(dwChunkStart));
      cueProps[4] = new Property("BlockStart", PropertyType.LONG, Long.valueOf(dwBlockStart));
      cueProps[5] = new Property("SampleOffset", PropertyType.LONG, Long.valueOf(dwSampleOffset));
      points.add(new Property("CuePoint", PropertyType.PROPERTY, PropertyArity.ARRAY, cueProps));
    }
    module.addWaveProperty(
        new Property("CuePoints", PropertyType.PROPERTY, PropertyArity.LIST, points));
    return true;
  }
}
