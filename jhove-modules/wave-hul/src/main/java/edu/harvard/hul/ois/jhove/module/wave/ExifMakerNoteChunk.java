...
/**
 * This class encapsulates the Exif Maker Note chunk. The format of this is manufacturer-depedent,
 * hence is regarded simply as an array of integers.
 *
 * @author Gary McGath
 */
public class ExifMakerNoteChunk extends Chunk {
   ...
   */
  public ExifMakerNoteChunk(ModuleBase module, ChunkHeader hdr, DataInputStream dstrm) {
