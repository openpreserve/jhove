...
/**
 * Implementation of the WAVE AXML Chunk, which contains arbitrary XML metadata, as specified in
 * <cite>Specification of the Broadcast Wave Format: A format for audio data files in broadcasting;
 * Supplement 5: &lt;axml&gt; Chunk</cite> (European Broadcasting Union)
 *
 * @author Gary McGath
 */
public class AXMLChunk extends Chunk {
   ...
   */
  public AXMLChunk(ModuleBase module, ChunkHeader hdr, DataInputStream dstrm) {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    module.addWaveProperty(new Property("XML", PropertyType.STRING, xmlData));
    return true;
  }
}
