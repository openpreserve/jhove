...
public class MpegChunk extends Chunk {
  ...
  public boolean readChunk(RepInfo info) throws IOException {
    ...
    propList.add(
        new Property(
            "AncillaryDataLength", PropertyType.INTEGER, new Integer(ancillaryDataLength)));
    propList.add(
        module.buildBitmaskProperty(
            ancillaryDataDef,
            "AncillaryDataDef",
    ...
    module.addWaveProperty(
        new Property("MPEG", PropertyType.PROPERTY, PropertyArity.LIST, propList));
    return true;
  }
}
