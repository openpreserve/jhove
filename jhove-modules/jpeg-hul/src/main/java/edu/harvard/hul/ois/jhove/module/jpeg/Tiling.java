...
public class Tiling {
  ...
  public Property buildTileListProp() {
    ...
    while (iter.hasNext()) {
      ...
      tProp[0] = new Property("VerticalScale", PropertyType.LONG, new Long(tile[0]));
      tProp[1] = new Property("HorizontalScale", PropertyType.LONG, new Long(tile[1]));
      tProp[2] = new Property("VerticalOffsret", PropertyType.LONG, new Long(tile[2]));
      tProp[3] = new Property("HorizontalOffset", PropertyType.LONG, new Long(tile[3]));
