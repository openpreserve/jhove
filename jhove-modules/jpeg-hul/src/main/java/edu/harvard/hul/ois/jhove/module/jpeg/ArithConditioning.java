...
public class ArithConditioning {
  ...
  public Property makeProperty(boolean raw) {
    ...
    if (raw) {
      parray[0] = new Property("TableClass", PropertyType.INTEGER, new Integer(_tableClass));
    } else {
    ...
    parray[1] =
        new Property("DestinationIdentifier", PropertyType.INTEGER, new Integer(_destIdentifier));
    return new Property(
        "ArithmeticConditioning", PropertyType.PROPERTY, PropertyArity.ARRAY, parray);
  }
}
