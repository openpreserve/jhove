...
public class SRS {
  ...
  public Property makeProperty() {
    ...
    parray[0] = new Property("VerticalOffset", PropertyType.INTEGER, new Integer(_vertOffset));
    parray[1] = new Property("HorizontalOffset", PropertyType.INTEGER, new Integer(_horOffset));
    parray[2] = new Property("VerticalSize", PropertyType.INTEGER, new Integer(_vertSize));
    parray[3] = new Property("HorizontalSize", PropertyType.INTEGER, new Integer(_horSize));
    return new Property(
        "SelectivelyRefinedScan", PropertyType.PROPERTY, PropertyArity.ARRAY, parray);
  }
}
