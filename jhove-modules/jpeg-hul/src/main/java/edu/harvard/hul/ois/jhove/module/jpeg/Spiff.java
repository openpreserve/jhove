...
public class Spiff {
  ...
  private static final int[] nisoColor = {
  ...
  private static final int[] nisoCompScheme = {
    1, // 0 uncompressed
    6, // 1 T.4, MH
    6, // 2 T.4, MR
    6, // 3 T.6, MMR
  ...
  /**
   * Converts S value to NISO color space. Return -1 if there is no matching color space in NISO, or
   * the S value is out of bounds.
   */
  ...
  /**
   * Converts C value to NISO compression scheme. Return -1 if there is no matching color space in
   * NISO, or the S value is out of bounds.
   */
