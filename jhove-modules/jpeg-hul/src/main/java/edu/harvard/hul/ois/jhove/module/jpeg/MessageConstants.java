...
/**
 * Enum used to externalise the JPEG modules message Strings. Using an enum INSTANCE as a "trick" to
 ...
 *   <li>ENTITY_NAME: the name of the entity causing the problem.
 ...
 * @version 0.1
 *     <p>Created 10 Oct 2016:20:54:20
 */
public enum MessageConstants {
  INSTANCE;
  public static final JhoveMessageFactory messageFactory =
      JhoveMessages.getInstance("edu.harvard.hul.ois.jhove.module.jpeg.ErrorMessages");
  public static final String INF_EXIF_REPORT_REQUIRES_TIFF =
      "TIFF-HUL module required to report Exif data";
  public static final String INF_EXIF_APP2_MULTI_REPORT =
      "ICCProfile in multiple APP2 segments; not handled by JPEG-hul";
