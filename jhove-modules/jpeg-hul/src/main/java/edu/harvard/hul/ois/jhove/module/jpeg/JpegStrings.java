...
public class JpegStrings {
  ...
  /**
   * JPEG compression types, indexed on marker byte - 0XC0. This applies only to marker codes for
   * the primary image; thumbnail compression schemes are completely incompatible.
   */
  ...
  public static final String[] CAPABILITY_V0 = {
    "", // 0
    ...
    "Hierarchical, Spectral Selection, " + "Huffman, 8-bits", // 20
    "Hierarchical, Spectral Selection, " + "arithmetic, 8-bits", // 21
    "Hierarchical, Full progression, " + "Huffman, 8-bits", // 22
    "Hierarchical, Full progression, " + "arithmetic, 8-bits", // 23
    "Hierarchical, Spectral Selection, " + "Huffman, 12-bits", // 24
    "Hierarchical, Spectral Selection, " + "arithmetic, 12-bits", // 25
    "Hierarchical, Full progression, " + "Huffman, 12-bits", // 26
    "Hierarchical, Full progression, " + "arithmetic, 12-bits", // 27
    "Hierarchical, Lossless, Huffman", // 28
    "Hierarchical, Lossless, arithmetic" // 29
  };

  /**
   * Values for capability indicator byte for Version 1. These are by bit position from right to
   * left.
   */
  public static final String[] CAPABILITY_V1 = {
   ...
   */
  public static final String[] TILING_CAPABILITY_V1 = {
    "No tiling", // 000x xxxx
   ...
   */
  public static final String[] TILING_TYPE = {
    "Simple", // 0
    "Pyramidal", // 1
    "Composite" // 2
  };
   ...
   */
  public static final String[] DQT_PRECISION = {
    "8-bit", // 0
    "16-bit", // 1
  };
   ...
   */
  public static final String[] DAC_CLASS = {
