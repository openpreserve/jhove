/**
 * ******************************************************************** JDump - JSTOR/Harvard Object
 * Validation Environment Copyright 2004 by the President and Fellows of Harvard College
 *
    ...
    try (FileInputStream file = new FileInputStream(args[0]);
      ...
      while (!endOfImage) {
        if (!readingECS) {
          if (!haveCode) {
            ...
            while (stream.readUnsignedByte() == 0xff) {
              System.out.println(leading(os, 8) + os + ": fill 0xff");
              os++;
            }
          }
        } else {
          ...
          System.out.println(leading(os, 8) + os + ": ECS" + nECS + " " + length + " ...");
          os += length;
          nECS++;
          readingECS = false;
          haveCode = true;
        ...
        if (code == 0x01) {
          ...
          int length = ModuleBase.readUnsignedShort(stream, bigEndian, null);
          int P = stream.readUnsignedByte();
          int Y = ModuleBase.readUnsignedShort(stream, bigEndian, null);
          int X = ModuleBase.readUnsignedShort(stream, bigEndian, null);
          ...
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DHT" + " " + length + " ...");
          os += length;
        } else if (code == 0xc8) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": JPG" + " " + length + " ...");
          os += length;
        } else if (code == 0xcc) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DAC" + " " + length + " ...");
          os += length;
          ...
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": SOS" + " " + length + " ...");
          os += length;

          readingECS = true;
        } else if (code == 0xdb) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DQT" + " " + length + " ...");
          os += length;
        } else if (code == 0xdc) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DNL" + " " + length + " ...");
          os += length;
        } else if (code == 0xdd) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DRI" + " " + length + " ...");
          os += length;
        } else if (code == 0xde) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DHP" + " " + length + " ...");
          os += length;
        } else if (code == 0xdf) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": EXP" + " " + length + " ...");
          os += length;
        } else if (code == 0xe0) {
          int length = ModuleBase.readUnsignedShort(stream, bigEndian, null);
          ...
          if ("JFIF\0".equals(id)) {
            ...
            int xDensity = ModuleBase.readUnsignedShort(stream, bigEndian, null);
            int yDensity = ModuleBase.readUnsignedShort(stream, bigEndian, null);
            ...
            System.out.print(leading(os, 8) + os + ": APP0 " + "0x" + leading(hex, 2) + hex);
            int n = length - 3;
            if (n > 0) {
              for (int i = 0; i < n; i++) {
                stream.readUnsignedByte();
            ...
            System.out.println(leading(os, 8) + os + ": APP0 " + length + " ...");
          ...
          */
          ...
          if ((n == 1 || n == 2) && length >= 8) {
            ...
            if ("Exif".equals(id) || "FPXR".equals(id)) {
              ...
              System.out.println(leading(os, 8) + os + ": APP" + n + " " + length + " ...");
            }
          ...
          System.out.print(leading(os, 8) + os + ": VER " + v + "." + rev);
          int n = length - 4;
          if (n > 0) {
            int[] cap = new int[n];
            for (int i = 0; i < n; i++) {
          ...
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DTI " + length + " ...");
          os += length;
        } else if (code == 0xf2) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DTT " + length + " ...");
          os += length;
        } else if (code == 0xf3) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": SRF " + length + " ...");
          os += length;
        } else if (code == 0xf4) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": SRS " + length + " ...");
          os += length;
        } else if (code == 0xf5) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DCR " + length + " ...");
          os += length;
        } else if (code == 0xf6) {
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": DQS " + length + " ...");
          os += length;
        } else if (code >= 0xf7 && code <= 0xfd) {
          int n = code - 0xf0;
          int length = markerSegment(stream, bigEndian);
          System.out.println(leading(os, 8) + os + ": JPG" + n + " " + length + " ...");
          os += length;
        } else if (code == 0xfe) {
          int length = ModuleBase.readUnsignedShort(stream, bigEndian, null);
          String comment = readChars(stream, length - 2);
          System.out.println(leading(os, 8) + os + ": COM \"" + comment + "\"");
          os += length;
        } else {
          int length = markerSegment(stream, bigEndian);
          String hex = Integer.toHexString(code);
          System.out.println(
              leading(os, 8) + os + ": RES (0x" + leading(hex, 2) + hex + ") " + length + " ...");
        }
        os += 2;
      }
