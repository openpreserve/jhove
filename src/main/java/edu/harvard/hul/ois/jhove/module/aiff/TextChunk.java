...
/**
 * Abstract superclass for the name, author, copyright, and annotation chunks,
...
public abstract class TextChunk extends Chunk {
	...
	/**
	 * Name of the property. The subclass constructor must set this
	 * appropriately.
	 */
	 ...
	 * 
	 * This method works for TextChunk, CopyrightChunk and AuthorChunk.
	 * AnnotationChunk overrides it, since there can be multiple annotations.
	 */
	@Override
	public boolean readChunk(RepInfo info) throws IOException {
		AiffModule module = (AiffModule) _module;
		String name = readText();
		module.addAiffProperty(new Property(propName, PropertyType.STRING, name));
		return true;
	}

	/**
	 * Reads the chunk's text data. All text chunk subclasses consist of a text
	 * string which takes up the full byte count of the chunk. By the
	 * specification, the text is required to be ASCII.
	 */
