...
public class CommonChunk extends Chunk {
	...
	public boolean readChunk(RepInfo info) throws IOException {
		...
		module.addAiffProperty(new Property("SampleFrames", PropertyType.LONG,
		...
		if (compressionType != null) {
			module.addAiffProperty(new Property("CompressionType",
					PropertyType.STRING, compressionType));
			if (compressionType.equals("NONE")) {
				// No compression == no action
	...
	/*
	 * Assign channel locationss according to the number of channels and the
	 * standard AIFF assignment.
	 */
