...
/**
 * Implementation of the AIFF Format Version Chunk. This chunk occurs only in
 * the AIFF/C variant.
 * 
 * @author Gary McGath
 *
...
public class FormatVersionChunk extends Chunk {
	 ...
	 */
	public FormatVersionChunk(AiffModule module, ChunkHeader hdr,
	...
	public boolean readChunk(RepInfo info) throws IOException {
		...
		module.addAiffProperty(new Property("FormatVersion", PropertyType.DATE,
				jTimestamp));
		return true;
	}
}
