 ...
 * These are identical except for one element apiece, so nearly all the code is
 * here or in its superclasses.
 * 
 * @author Gary McGath
 *
 */
public abstract class Html4_01TFDocDesc extends Html4TFDocDesc {
	...
	/**
	 * Initialization code. This is called from the static initializer of our
	 * subclasses.
	 */
	...
	private static void addImgElement(Map stSupportedElements) {
		...
		atts.add(new HtmlAttributeDesc("align", new String[] { "top", "middle",
				"bottom", "left", "right" }, HtmlAttributeDesc.IMPLIED));
