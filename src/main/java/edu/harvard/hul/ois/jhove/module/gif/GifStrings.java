...
public class GifStrings {
	...
	/**
	 * A private constructor just to make sure nobody instantiates the class by
	 * mistake.
	 */
	private GifStrings() {
	}
	...
	public final static String[] COLOR_TABLE_SORT_FLAG = { "Not ordered",
			"Ordered by decreasing importance" };

	/**
	 * GIF Capabilities Enquiry string: way in which the graphic is to be
	 * treated after being displayed
	 */
	public final static String[] GCE_DISPOSAL_METHOD = {
			"No disposal specified", "Do not dispose",
			"Restore to background color", "Restore to previous" };
	...
	public final static String[] INTERLACE_FLAG = { "Image is not interlaced",
			"Image is interlaced" };
