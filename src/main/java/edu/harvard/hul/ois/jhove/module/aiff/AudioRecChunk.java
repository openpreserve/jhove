 ...
 *
 * The data bytes are put into an uninterpreted byte array Property. These are
 * specified in the AES Recommended Practice for Digital Audio Engineering -
 * Serial Transmission Format for Linearly Represented Digital Audio Data,
...
public class AudioRecChunk extends Chunk {
	 ...
	 */
	public AudioRecChunk(AiffModule module, ChunkHeader hdr,
			DataInputStream dstrm) {
		super(module, hdr, dstrm);
	}

	/**
	 * Reads a chunk and puts an AudioRecording property into the RepInfo
	 * object.
	 * 
	...
	public boolean readChunk(RepInfo info) throws IOException {
		...
		if (bytesLeft != 24) {
			...
			info.setMessage(new ErrorMessage(
					"Audio Recording Chunk is incorrect size", module
							.getNByte()));
		...
		module.addAiffProperty(new Property("AudioRecording",
				PropertyType.BYTE, PropertyArity.ARRAY, buf));
		return true;
	}
