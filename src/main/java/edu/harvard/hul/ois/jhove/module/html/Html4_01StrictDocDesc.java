...
public class Html4_01StrictDocDesc extends Html4StrictDocDesc {
	...
	static {
		...
		HtmlAttributeDesc valignAtt = new HtmlAttributeDesc("valign",
				...
				HtmlAttributeDesc.IMPLIED);
		List cellalignAttrs = new ArrayList(4); // combine cellhalign and
												// cellvalign
		cellalignAttrs.add(new HtmlAttributeDesc("align", new String[] {
	...
	private static void addInputElement(Map stSupportedElements) {
		...
		atts.add(new HtmlAttributeDesc("type", new String[] { "text",
				...
				"hidden", "image", "button" }, HtmlAttributeDesc.OTHER));
