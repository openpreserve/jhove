...
public class ApplicationChunk extends Chunk {
	 ...
	 */
	public ApplicationChunk(AiffModule module, ChunkHeader hdr,
	...
	public boolean readChunk(RepInfo info) throws IOException {
		...
		propArr[0] = new Property("ApplicationSignature", PropertyType.STRING,
		...
		if ("stoc".equals(applicationSignature)
			...
			propArr[1] = new Property("ApplicationName", PropertyType.STRING,
					appName);
		} else {
			propArr[1] = new Property("Data", PropertyType.BYTE,
					PropertyArity.ARRAY, data);
		}
		module.addAiffProperty(new Property("Application",
				PropertyType.PROPERTY, PropertyArity.ARRAY, propArr));
