...
Build Status: [![Build Status](https://travis-ci.org/willp-bl/jhove.svg?branch=travis)](https://travis-ci.org/willp-bl/jhove)
...
This is the beginning of an attempt to convert to Maven. Everything has
moved around. Stick with 1.11 until this works, unless you're helping to
get it to build.
