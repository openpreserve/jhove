...
public class SbitChunk extends PNGChunk {
  ...
  /**
   * The SBIT chunk contains 1 to 4 bytes of information giving the number of significant bits per
   * color. Ideally, we should check this against the color model.
   */
  @Override
  public void processChunk(RepInfo info) throws Exception {
    ...
    Property prop =
        new Property("Significant bits", PropertyType.INTEGER, PropertyArity.ARRAY, sbitVal);
    _propList.add(prop);
  }
}
