...
public class PhysChunk extends PNGChunk {
  ...
  public void processChunk(RepInfo info) throws Exception {
    ...
    Property prop =
        new Property("X pixels per unit", PropertyType.INTEGER, Long.valueOf(xPixelsPerUnit));
    info.setProperty(prop);
    prop = new Property("Y pixels per unit", PropertyType.INTEGER, Long.valueOf(yPixelsPerUnit));
    info.setProperty(prop);
    String unitStr;
    switch (unit) {
      case 0:
    ...
    prop = new Property("Pixel unit", PropertyType.STRING, unitStr);
    info.setProperty(prop);
