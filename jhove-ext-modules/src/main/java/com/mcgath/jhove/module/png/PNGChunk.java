...
public abstract class PNGChunk {
  ...
  protected boolean
      duplicateAllowed; // ancillary chunks only -- if false, no duplicates of this type allowed
   ...
   */
  protected static final int IHDR_HEAD_SIG = 0x49484452;
  protected static final int PLTE_HEAD_SIG = 0x504c5445;
  protected static final int IDAT_HEAD_SIG = 0x49444154;
  protected static final int IEND_HEAD_SIG = 0x49454e44;
  protected static final int cHRM_HEAD_SIG = 0x6348524d;
  protected static final int gAMA_HEAD_SIG = 0x67414d41;
  protected static final int iCCP_HEAD_SIG = 0x69434350;
  protected static final int sBIT_HEAD_SIG = 0x73424954;
  protected static final int sRGB_HEAD_SIG = 0x73524742;
  protected static final int tEXt_HEAD_SIG = 0x74455874;
  protected static final int zTXt_HEAD_SIG = 0x7a545874;
  protected static final int iTXt_HEAD_SIG = 0x69545874;
  protected static final int bKGD_HEAD_SIG = 0x624b4744;
  protected static final int hIST_HEAD_SIG = 0x68495354;
  protected static final int pHYs_HEAD_SIG = 0x70485973;
  protected static final int sPLT_HEAD_SIG = 0x73504c54;
  protected static final int tIME_HEAD_SIG = 0x74494d45;
  protected static final int tRNS_HEAD_SIG = 0x74524e53;
  ...
  /**
   * Process a chunk. When this is called, the input stream needs to have read the type and length
   * and be positioned at the start of the data.
   *
   * <p>The default behavior is to eat the chunk. This should be the behavior only for UnknownChunk
   * when we're done.
   */
      ...
      if (_module.isChunkSeen(chunkType)) {
        ErrorMessage msg =
            new ErrorMessage(
                ...
                String.format(MessageConstants.PNG_GDM_38_SUB.getMessage(), chunkTypeString()));
        info.setMessage(msg);
