...
public class SrgbChunk extends PNGChunk {
  ...
  public void processChunk(RepInfo info) throws Exception {
    ...
    if (_module.isPlteSeen()) {
      ...
      if (colorIntent > 3) {
        msg =
            new ErrorMessage(String.format(MessageConstants.PNG_GDM_52.getMessage(), colorIntent));
      }
    }
    if (msg != null) {
      info.setMessage(msg);
    ...
    Property prop =
        new Property("SRGB rendering intent", PropertyType.STRING, intents[colorIntent]);
