...
public class BkgdChunk extends PNGChunk {
   ...
   *
   * <p>The greyscale, RGB, and palette backgrounds are all different kinds of data, so make them
   * three different properties so that processing software doesn't get confused.
   *
    ...
    if (_module.isIdatSeen()) {
      ...
      switch (colorType) {
        ...
        case 4:
          ...
          Property grayProp = new Property("Gray background value", PropertyType.INTEGER, grayBkgd);
        ...
        case 6:
          ...
          Property redProp = new Property("Red background value", PropertyType.INTEGER, redBkgd);
          info.setProperty(redProp);
          Property greenProp =
              new Property("Green background value", PropertyType.INTEGER, greenBkgd);
          info.setProperty(greenProp);
          Property blueProp = new Property("Blue background value", PropertyType.INTEGER, blueBkgd);
          info.setProperty(blueProp);
          break;
        case 3:
          int bkgdIndex = readUnsignedByte();
          Property bkgdProp =
              new Property("Background palette index", PropertyType.INTEGER, bkgdIndex);
