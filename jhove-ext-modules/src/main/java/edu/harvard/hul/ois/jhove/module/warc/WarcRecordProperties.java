 ...
 *
 * <p>Based on the WARC property classes from JHOVE2.
 *
 * @author jolf
 */
public class WarcRecordProperties {
  ...
  /**
   * Retrieves the WARC record properties as a map. Starts by extracting the base properties for all
   * WARC records, then adds the specific properties for the given type of WARC record.
   *
