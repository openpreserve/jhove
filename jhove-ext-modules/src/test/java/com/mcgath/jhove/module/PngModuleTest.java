...
public class PngModuleTest {
  ...
  private static final String ITXTCHUNK_PNG_FILEPATH =
      "src/test/resources/png/FileWithiTXtChunks.png";
  private static final String PNG_MIMETYPE = "image/png";

  /**
   * Parses valid PNG file with an iTXt Chunk and checks Author value is picked up. This test
   * relates to an NPE issue (#148) in v.1.24: Test file is "cten0g04.png", copied from PNG test
   * suite at http://www.schaik.com/pngsuite/
   *
   * @see <a href=
   *     "https://github.com/openpreserve/jhove/issues/148">https://github.com/openpreserve/jhove/issues/148</a>
   * @see <a href= "http://www.schaik.com/pngsuite/">http://www.schaik.com/pngsuite/</a>
   * @throws Exception
   */
  @Test
  public void parsePngWithItxtChunk() throws Exception {
    ...
    LinkedList<Property> iTxtKeywordProperties =
        (LinkedList<Property>) info.getByName(PROP_KEYWORDS).getValue();
