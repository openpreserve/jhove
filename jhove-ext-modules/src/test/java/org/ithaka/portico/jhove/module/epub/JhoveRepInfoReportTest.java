...
public class JhoveRepInfoReportTest {
  ...
  /**
   * Sets a single fatal message then confirms the properties are correct when you getAllMessages()
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Adds 2 different messages to report and confirms they are returned by getAllMessages()
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Adds 2 messages to report that are the same ID but have different locations and confirms they
   * are returned as 1 message by getAllMessages()
   *
   * @throws Exception
   */
  @Test
