...
public class GzipModuleTest {
  ...
  private static final String THREE_FILES_GZIP_SAMPLE_FILE =
      "src/test/resources/gzip/three-files.gz";
  ...
  public void parseInvalidTruncatedGzipFile() throws Exception {
    ...
    assertTrue(
        errorMessage + " should contain " + DataFormatException.class.toString(),
