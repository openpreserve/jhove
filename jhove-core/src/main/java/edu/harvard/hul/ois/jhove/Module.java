 ...
 *
 * <p>All format modules must implement the Module interface; usually the best way to do this will
...
public interface Module {
  ...
  /**
   * Returns the random access flag (true if the module operates on random access files, false if it
   * operates on streams)
   */
   ...
   * will normally implement only one of the two parse methods, leaving the other as a stub.
   *
