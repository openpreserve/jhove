...
/**
 * Abstract base class for Jhove output handlers. Output handlers should normally subclass
 * HandlerBase.
 */
public abstract class HandlerBase implements OutputHandler {
  ...
  /**
   * A DateFormat for representing a Date in yyyy-MM-dd HH:mm:ss z (e.g., 2003-07-31 15:31:12 EDT)
   * format.
   */
  ...
  /**
   * A DateFormat for representing a Date in ISO 8601 (e.g., 2003-07-31T15:31:12-0400) format. We
   * subclass SimpleDateFormat to make it thread-safe.
   */
  ...
  /**
   * Constructors of all subclasses of HandlerBase should call this as a <code>super</code>
   * constructor.
   *
   ...
   *     numbers. <code>date[0]</code> is the year, <code>date[1]</code> the month, and <code>
   *     date[2]</code> the day.
  ...
  /**
   * Returns a list of <code>Document</code> objects (one for each specification document). The
  ...
  /**
   * Callback to give the handler the opportunity to decide whether or not to process a file. Most
   * handlers will always return true.
   *
