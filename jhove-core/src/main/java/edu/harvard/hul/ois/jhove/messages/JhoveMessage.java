...
/**
 * Interface that defines behaviour of JhoveMessages. These messages have a unique string identifier
 * as well as the previous message and sub-message strings.
 *
