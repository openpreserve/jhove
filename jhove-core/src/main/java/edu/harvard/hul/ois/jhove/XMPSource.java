 ...
 * supported.
 *
 * <p>Each module can provide its own subclass of XMPSource. The subclass must provide a way to
 * reset to the beginning and reread the data when makeProperty is called.
 *
 * @author Gary McGath
 */
public abstract class XMPSource extends InputSource {
  ...
  /**
   * Generates a property from the underlying data. The beginning and ending processing instructions
   * are stripped out.
   */
  ...
  /**
   * Causes reading to begin from the start again. Typically this means creating a new value for
