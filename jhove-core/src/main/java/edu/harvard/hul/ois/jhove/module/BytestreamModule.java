...
/**
 * Module for analysis of content as a byte stream. This is the module of last resort, accepting any
 * content as valid and well-formed.
 */
public final class BytestreamModule extends ModuleBase {
  ...
  /**
   * Parse the content of a stream digital object and store the results in RepInfo. Any arbitrary
   * bytestream is considered well-formed.
   */
  @Override
  ...
  /**
   * Check signature. Bytestreams have no signatures, but since any byte stream is considered a
   * valid Bytestream, return immediately doing nothing. The RepInfo._consistent flag will remain
   * true.
   */
  @Override
