...
public class Checksummer implements java.util.zip.Checksum {
  ...
  /**
   * Returns the value of the MD5 digest as a hex string. Returns null if the digest is not
   * available.
   */
  ...
  /**
   * Returns the value of the SHA-1 digest as a hex string. Returns null if the digest is not
   * available.
   */
  ...
  /**
   * Returns the value of the SHA-256 digest as a hex string. Returns null if the digest is not
   * available.
   */
  ...
  /**
   * Pad a hexadecimal (or other numeric) string out to the specified length with leading zeroes.
   */
