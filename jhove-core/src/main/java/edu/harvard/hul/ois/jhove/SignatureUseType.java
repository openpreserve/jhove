...
/**
 * This class defines enumerated use types for a Signature in a module. These give information on
 * whether a signature is required in valid content. Applications will not create or modify
 * SignatureUseTypes, but will use one of the predefined SignatureUseType instances MANDATORY,
 * MANDATORY_IF_APPLICABLE, or OPTIONAL.
 *
 * @see Signature
 */
