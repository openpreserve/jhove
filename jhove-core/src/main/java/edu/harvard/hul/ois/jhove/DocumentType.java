...
/**
 * This class defines enumerated types for a Document. Applications will not create or modify
 * DocumentTypes, but will use one of the predefined DocumentType instances ARTICLE, BOOK, REPORT,
 * RFC, STANDARD, WEB, or OTHER.
 *
 * @see Document
 */
