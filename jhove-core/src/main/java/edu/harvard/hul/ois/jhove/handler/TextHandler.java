 ...
 * Validation Environment Copyright 2003-2004 by JSTOR and the President and Fellows of Harvard
 * College
 *
...
public class TextHandler extends HandlerBase {
  ...
  public void show(App app) {
    ...
    _writer.println(
        margin + " API: " + app.getRelease() + ", " + HandlerBase.date.format(_je.getDate()));
    ...
    while (iter.hasNext()) {
      ...
      _writer.println(margin + " Module: " + module.getName() + " " + module.getRelease());
    }
    iter = _je.getHandlerMap().keySet().iterator();
    while (iter.hasNext()) {
      OutputHandler handler = _je.getHandler(iter.next());
      _writer.println(margin + " OutputHandler: " + handler.getName() + " " + handler.getRelease());
    }
  ...
  public void show(OutputHandler handler) {
    ...
    _writer.println(margin + " Date: " + HandlerBase.date.format(handler.getDate()));
  ...
  public void show(Module module) {
    ...
    _writer.println(margin + " Date: " + HandlerBase.date.format(module.getDate()));
  ...
  public void showHeader() {
    ...
    _writer.println(
        margin
            ...
            + ")");
    _writer.println(margin + " Date: " + HandlerBase.dateTime.format(new Date()));
  }
  ...
  private void showSignature(Signature signature) {
    ...
    _writer.println(margin + signature.getType().toString() + ": " + sigValue);
    if ((signature.getType().equals(SignatureType.MAGIC))
        && (((InternalSignature) signature).hasFixedOffset())) {
      _writer.println(margin + " Offset: " + ((InternalSignature) signature).getOffset());
    }
  ...
  private void showScalarProperty(Property property, String margin) {
    ...
    if (PropertyType.PROPERTY.equals(type)) {
      ...
      showNisoImageMetadata(
          (NisoImageMetadata) property.getValue(), margin + " ", _je.getShowRawFlag());
    } else if (PropertyType.AESAUDIOMETADATA.equals(type)) {
      showAESAudioMetadata(
          (AESAudioMetadata) property.getValue(), margin + " ", _je.getShowRawFlag());
    } else if (PropertyType.TEXTMDMETADATA.equals(type)) {
      showTextMDMetadata((TextMDMetadata) property.getValue(), margin + " ", _je.getShowRawFlag());
    } else {
    ...
    if (n > 0) {
      ...
      for (i = 0; i < n; i++) {
        if (valueIsProperty) {
          ...
          showNisoImageMetadata(
              (NisoImageMetadata) list.get(i), margin + " ", _je.getShowRawFlag());
        } else if (valueIsTextMD) {
          showTextMDMetadata((TextMDMetadata) list.get(i), margin + " ", _je.getShowRawFlag());
        } else {
  ...
  private void showMapProperty(Property property, String margin) {
    ...
    while (propiter.hasNext()) {
      ...
      if (valueIsProperty) {
        ...
        showNisoImageMetadata((NisoImageMetadata) val, margin + " ", _je.getShowRawFlag());
      } else if (valueIsTextMD) {
        showTextMDMetadata((TextMDMetadata) val, margin + " ", _je.getShowRawFlag());
      } else {
  ...
  private void showArrayProperty(Property property, String margin) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (PropertyType.BOOLEAN.equals(propType)) {
        ...
        showTextMDMetadata(textMDArray[i], margin + " ", _je.getShowRawFlag());
        continue;
      } else if (PropertyType.PROPERTY.equals(propType)) {
        if (i == 0) {
          _writer.println();
  ...
  private void showAESAudioMetadata(AESAudioMetadata aes, String margin, boolean rawOutput) {
    ...
    if (!facelist.isEmpty()) {
      ...
      if (nchan != AESAudioMetadata.NULL) {
        _writer.println(margn4 + "NumChannels: " + Integer.toString(nchan));
      }
    ...
    if (!flist.isEmpty()) {
      ...
      if (bitDepth != AESAudioMetadata.NULL
        ...
        if (bitRed != null) {
          ...
          _writer.println(margn5 + "codecCreatorApplication: " + bitRed[2]);
          _writer.println(margn5 + "codecCreatorApplicationVersion: " + bitRed[3]);
  ...
  private void writeAESTimeRange(
    ...
    _writer.println(margn2 + "Minutes: " + Long.toString(start.getMinutes()));
    _writer.println(margn2 + "Seconds: " + Long.toString(start.getSeconds()));
    ...
    _writer.println(margn3 + "NumberOfSamples: " + Long.toString(start.getSamples()));
    ...
    if (duration != null) {
      ...
      _writer.println(margn2 + "VideoField: FIELD_1");
      _writer.println(margn2 + "CountingMode: NTSC_NON_DROP_FRAME");
      _writer.println(margn2 + "Hours: " + Long.toString(duration.getHours()));
      _writer.println(margn2 + "Minutes: " + Long.toString(duration.getMinutes()));
      _writer.println(margn2 + "Seconds: " + Long.toString(duration.getSeconds()));
      _writer.println(margn2 + "Frames: " + Long.toString(duration.getFrames()));
      _writer.println(margn2 + "Samples: ");
      ...
      _writer.println(margn3 + "SampleRate: S" + Integer.toString((int) sr));
      _writer.println(margn3 + "NumberOfSamples: " + Long.toString(duration.getSamples()));
      _writer.println(margn2 + "FilmFraming: NOT_APPLICABLE");
      _writer.println(margn3 + "Type: ntscFilmFramingType");
    }
  }
   ...
   * may be 0.2 or 1.0, depending on the module parameters.
   *
  ...
  private void showNisoImageMetadata02(NisoImageMetadata niso, String margin, boolean rawOutput) {
    ...
    if ((n = niso.getColorSpace()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "ColorSpace: "
              + addIntegerValue(
                  n, NisoImageMetadata.COLORSPACE, NisoImageMetadata.COLORSPACE_INDEX, rawOutput));
    }
    ...
    if ((n = niso.getYCbCrPositioning()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "YCbCrPositioning: "
              + addIntegerValue(n, NisoImageMetadata.YCBCR_POSITIONING, rawOutput));
    }
    Rational[] rarray = niso.getYCbCrCoefficients();
    if (rarray != null) {
      _writer.print(margn2 + "YCbCrCoefficients: " + addRationalValue(rarray[0], rawOutput));
    ...
    if (rarray != null) {
      _writer.print(margn2 + "ReferenceBlackWhite: " + addRationalValue(rarray[0], rawOutput));
      for (int i = 1; i < rarray.length; i++) {
        _writer.print(", " + addRationalValue(rarray[i], rawOutput));
      }
      _writer.println();
    ...
    if ((n = niso.getSegmentType()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "SegmentType: " + addIntegerValue(n, NisoImageMetadata.SEGMENT_TYPE, rawOutput));
    }
    ...
    if ((n = niso.getPlanarConfiguration()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "PlanarConfiguration: "
              + addIntegerValue(n, NisoImageMetadata.PLANAR_CONFIGURATION, rawOutput));
    }
    ...
    if ((n = niso.getChecksumMethod()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "ChecksumMethod: "
              + addIntegerValue(n, NisoImageMetadata.CHECKSUM_METHOD, rawOutput));
    }
    ...
    if ((n = niso.getOrientation()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "Orientation: " + addIntegerValue(n, NisoImageMetadata.ORIENTATION, rawOutput));
    }
    if ((n = niso.getDisplayOrientation()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "DisplayOrientation: "
              + addIntegerValue(n, NisoImageMetadata.DISPLAY_ORIENTATION, rawOutput));
    }
    ...
    if ((n = niso.getMeteringMode()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "MeteringMode: "
              + addIntegerValue(n, NisoImageMetadata.METERING_MODE, rawOutput));
    }
    ...
    if ((n = niso.getFlash()) != NisoImageMetadata.NULL) {
      _writer.println(margn2 + "Flash: " + addIntegerValue(n, NisoImageMetadata.FLASH, rawOutput));
    }
    ...
    if ((n = niso.getFlashReturn()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "FlashReturn: " + addIntegerValue(n, NisoImageMetadata.FLASH_RETURN, rawOutput));
    }
    if ((n = niso.getBackLight()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "BackLight: " + addIntegerValue(n, NisoImageMetadata.BACKLIGHT, rawOutput));
    }
    ...
    if ((n = niso.getAutoFocus()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "AutoFocus: " + addIntegerValue(n, NisoImageMetadata.AUTOFOCUS, rawOutput));
    }
    ...
    if ((n = niso.getSensor()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "Sensor: " + addIntegerValue(n, NisoImageMetadata.SENSOR, rawOutput));
    }
    ...
    if ((n = niso.getSamplingFrequencyPlane()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              ...
              + addIntegerValue(n, NisoImageMetadata.SAMPLING_FREQUENCY_PLANE, rawOutput));
    }
    if ((n = niso.getSamplingFrequencyUnit()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "SamplingFrequencyUnit: "
              + addIntegerValue(n, NisoImageMetadata.SAMPLING_FREQUENCY_UNIT, rawOutput));
    }
    r = niso.getXSamplingFrequency();
    if (r != null) {
      _writer.println(margn2 + "XSamplingFrequency: " + addRationalValue(r, rawOutput));
    }
    r = niso.getYSamplingFrequency();
    if (r != null) {
      _writer.println(margn2 + "YSamplingFrequency: " + addRationalValue(r, rawOutput));
    }
    ...
    if ((n = niso.getSourceXDimensionUnit()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              ...
              + addIntegerValue(n, NisoImageMetadata.SOURCE_DIMENSION_UNIT, rawOutput));
    }
    ...
    if ((iarray = niso.getExtraSamples()) != null) {
      _writer.print(
          margn2
              + "ExtraSamples: "
              + addIntegerValue(iarray[0], NisoImageMetadata.EXTRA_SAMPLES, rawOutput));
      for (int i = 1; i < iarray.length; i++) {
        _writer.print(
            ", " + addIntegerValue(iarray[i], NisoImageMetadata.EXTRA_SAMPLES, rawOutput));
      }
      _writer.println();
    }
    ...
    if ((n = niso.getGrayResponseUnit()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "GrayResponseUnit: "
              + addIntegerValue(n, NisoImageMetadata.GRAY_RESPONSE_UNIT_02, rawOutput));
    }
    r = niso.getWhitePointXValue();
    if (r != null) {
      _writer.println(margn2 + "WhitePointXValue: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getWhitePointYValue()) != null) {
      _writer.println(margn2 + "WhitePointXValue: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getPrimaryChromaticitiesRedX()) != null) {
      _writer.println(margn2 + "PrimaryChromaticitiesRedX: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getPrimaryChromaticitiesRedY()) != null) {
      _writer.println(margn2 + "PrimaryChromaticitiesRedY: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getPrimaryChromaticitiesGreenX()) != null) {
      _writer.println(margn2 + "PrimaryChromaticitiesGreenX: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getPrimaryChromaticitiesGreenY()) != null) {
      _writer.println(margn2 + "PrimaryChromaticitiesGreenY: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getPrimaryChromaticitiesBlueX()) != null) {
      _writer.println(margn2 + "PrimaryChromaticitiesBlueX: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getPrimaryChromaticitiesBlueY()) != null) {
      _writer.println(margn2 + "PrimaryChromaticitiesBlueY: " + addRationalValue(r, rawOutput));
    }
    if ((n = niso.getTargetType()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "TargetType: " + addIntegerValue(n, NisoImageMetadata.TARGET_TYPE, rawOutput));
    }
  ...
  private void showNisoImageMetadata10(NisoImageMetadata niso, String margin, boolean rawOutput) {
    ...
    if (xres != NisoImageMetadata.NULL && yres != NisoImageMetadata.NULL) {
      ...
      _writer.println(margn2 + "MaximumOpticalResolution: " + Double.toString(res));
    }
    if ((s = niso.getScanningSoftware()) != null) {
      _writer.println(margn2 + "ScanningSoftware: " + s);
    }
    ...
    if ((r = niso.getMaxApertureValue()) != null) {
      _writer.println(margn2 + "MaxApertureValue: " + addRationalValue(r, rawOutput));
    }
    if ((d = niso.getExposureTime()) != NisoImageMetadata.NILL) {
    ...
    if ((n = niso.getExposureProgram()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2
              + "ExposureProgram: "
              + addIntegerValue(n, NisoImageMetadata.EXPOSURE_PROGRAM, rawOutput));
    }
    if ((r = niso.getBrightness()) != null) {
      _writer.println(margn2 + "BrightnessValue: " + addRationalValue(r, rawOutput));
    }
    if ((r = niso.getExposureBias()) != null) {
    ...
    if ((r = niso.getFlashEnergy()) != null) {
      _writer.println(margn2 + "FlashEnergy: " + addRationalValue(r, rawOutput));
    }
    if ((n = niso.getBackLight()) != NisoImageMetadata.NULL) {
      _writer.println(
          margn2 + "BackLight: " + addIntegerValue(n, NisoImageMetadata.BACKLIGHT, rawOutput));
