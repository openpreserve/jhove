...
public enum Utils {
  ...
  /**
   * Encodes a content String in XML-clean form, converting characters to entities as necessary and
   * removing control characters disallowed by XML. The null string will be converted to an empty
   * string.
   */
  ...
  /**
   * Encodes an attribute value String in XML-clean form, converting quote characters to entities
   * and removing control characters disallowed by XML.
   */
