...
public enum CoreMessageConstants {
	...
	public static final String EXC_MAP_PROP_CLSS_INCMPT = "Incompatible class for property: Map.";
	public static final String EXC_SET_PROP_CLSS_INCMPT = "Incompatible class for property: Set";
	public static final String EXC_LIST_PROP_CLSS_INCMPT = "Incompatible class for property: List";
