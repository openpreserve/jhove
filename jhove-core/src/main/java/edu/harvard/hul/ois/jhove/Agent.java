...
public final class Agent {
  private static final Agent HARVARD =
      new Builder("Harvard University Library", AgentType.EDUCATIONAL)
          .address(
  ...
  private static final Agent OPF =
      new Builder("Open Preservation Foundation", AgentType.NONPROFIT)
          .web("http://openpreservation.org")
          .email("jhove@openpreservation.org")
          .build();

  private static final Agent BNF =
      new Builder("Bibliothèque nationale de France", AgentType.EDUCATIONAL)
          .web("http://www.bnf.fr")
          .build();
  ...
  public int hashCode() {
    ...
    result = prime * result + ((_telephone == null) ? 0 : _telephone.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!_email.equals(other._email)) return false;
    if (_fax == null) {
      if (other._fax != null) return false;
    } else if (!_fax.equals(other._fax)) return false;
    if (_name == null) {
      if (other._name != null) return false;
    } else if (!_name.equals(other._name)) return false;
    if (_note == null) {
      if (other._note != null) return false;
    } else if (!_note.equals(other._note)) return false;
    if (_telephone == null) {
      if (other._telephone != null) return false;
    } else if (!_telephone.equals(other._telephone)) return false;
    if (_type == null) {
      if (other._type != null) return false;
    } else if (!_type.equals(other._type)) return false;
    if (_web == null) {
      if (other._web != null) return false;
    } else if (!_web.equals(other._web)) return false;
    return true;
  }

  public static final Agent newW3CInstance() {
    Builder builder =
        new Builder("Word Wide Web Consortium", AgentType.NONPROFIT)
            .address(
                "Massachusetts Institute of Technology, "
                    + "Computer Science and Artificial Intelligence Laboratory, "
                    + "32 Vassar Street, Room 32-G515, "
                    + "Cambridge, MA 02139")
            .telephone("(617) 253-2613")
            .fax("(617) 258-5999")
            .web("http://www.w3.org/");
  ...
  public static final Agent newIsoInstance() {
    Builder builder =
        new Builder("ISO", AgentType.STANDARD)
            .address("1, rue de Varembe, Casa postale 56, " + "CH-1211, Geneva 20, Switzerland")
  ...
  public static final Agent newAdobeInstance() {
    Builder builder =
        new Builder("Adobe Systems, Inc.", AgentType.COMMERCIAL)
