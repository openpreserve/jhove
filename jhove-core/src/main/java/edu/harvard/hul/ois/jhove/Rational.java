...
/**
 * This class encapsulates a number which is defined as the ratio of two 32-bit unsigned integers,
 * in accordance with the TIFF specification.
 */
public class Rational {
  ...
  /**
   * The arguments to this constructor are long in order to represent all possible 32-bit unsigned
   * integers. Parameters greater than 2 ^ 32 - 1 are not meaningful.
   *
