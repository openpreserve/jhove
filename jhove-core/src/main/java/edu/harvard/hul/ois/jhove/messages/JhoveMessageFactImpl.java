...
final class JhoveMessageFactImpl implements JhoveMessageFactory {
  ...
  static JhoveMessageFactImpl getInstance(final ResourceBundle messageBundle)
      throws IllegalArgumentException {
    if (messageBundle == null) throw new IllegalArgumentException("messageBundle cannot be null");
