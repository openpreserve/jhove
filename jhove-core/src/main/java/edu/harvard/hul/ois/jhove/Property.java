 ...
 * enumerations given by <code>PropertyType</code>.
 *
 * <p>The components of a Property may themselves be Property objects, allowing nested structures.
 *
 * @see PropertyType
 * @see PropertyArity
 */
public class Property {
   ...
   * @param value The value of the property. The type of the parameter must agree with <code>type
   *     </code>.
   */
   ...
   *     agree with <code>type</code>. Otherwise, the arity must agree with <code>arity</code>, and
   *     its components must agree with <code>type</code>.
   */
  ...
  /**
   * Returns the type of this Property. If the arity is other than SCALAR, the type refers to the
