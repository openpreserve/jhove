...
/**
 * This class encapsulates information about format signatures, both internal and external. The
 * value of a Signature may be either a String or a byte array (stored as an int array to avoid
 * signed byte problems).
 */
public abstract class Signature {
  ...
  /**
   * A Signature cannot be created directly; this constructor can be called as the superclass
   * constructor from a subclass. This constructor uses a String value.
   */
  ...
  /**
   * A Signature cannot be created directly; this constructor can be called as the superclass
   * constructor from a subclass. This constructor uses a byte array (stored as an int array) value.
   */
  ...
  /**
   * A Signature cannot be created directly; this constructor can be called as the superclass
   * constructor from a subclass. This constructor uses a String value and allows specification of a
   * note.
   */
  ...
  /**
   * Returns the byte array value for this Signature. If this Signature was constructed from a
   * String, it returns the characters of the String as the bytes of the array.
   */
  public int[] getValue() {
    return _value;
  }
  ...
  /**
   * Returns the string value of this Signature. Returns null if this Signature was constructed with
   * an array.
   */
  ...
  /**
   * Returns the value of this Signature as a hexadecimal string. The length of the string is twice
   * the length of the array or string from which this Signature was created, and all alphabetic
