...
public class XMLWrapperStream extends InputStream {
  ...
  /* Values for state */
  private static final int DECL = 0, ROOT_START = 1, CONTENT = 2, ROOT_END = 3;
   ...
   * @param rootName The name of the root element. May be null if <code>wrappedStream</code> already
   *     contains a root element.
   * @param version The XML version. Should be null or "1.0" unless there's a really good reason.
  ...
  /**
   * Constructor. Equivalent to <code>XMLWrapperStream (wrappedStream, null, null, null, null)
   * </code>
   *
   * @param wrappedStream The stream which this stream will subsume.
   */
  ...
  /**
   * Constructor. Equivalent to <code>XMLWrapperStream (wrappedStream, rootName, null, null, null)
   * </code>
   *
   * @param wrappedStream The stream which this stream will subsume.
