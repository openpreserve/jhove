...
public enum JhoveMessages {
   ...
   *
   * @param message the message of the new message
   * @return the new message instance
   * @throws IllegalArgumentException if the id or message is null or empty
   */
   ...
   * @throws IllegalArgumentException if the id or message is null or empty
   */
  public static JhoveMessage getMessageInstance(final String id, final String message)
      throws IllegalArgumentException {
   ...
   * @param id the id of the new message
   * @param message the message of the new message
   * @param subMessage the sub-message of the new message
   * @return the new message instance
   * @throws IllegalArgumentException if the id or message is null or empty
   */
  public static JhoveMessage getMessageInstance(
      final String id, final String message, final String subMessage)
      throws IllegalArgumentException {
  ...
  /**
   * Get a JhoveMessageFactory instance with the requested property based bundle name and the
   * default user locale
   *
   * @param bundleName the fully qualified resource path for the message bundle property file
   * @return a new JhoveMessageFactory instance backed by the bundle property file.
   * @throws IllegalArgumentException if the bundle name is empty or the message bundle can't be
   *     located
   */
  ...
  /**
   * Get a JhoveMessageFactory instance with the requested property based bundle name and a specific
   * locale
   *
   * @param bundleName the fully qualified resource path for the message bundle property file
   * @param locale the locale for the message bundle
   * @return a new JhoveMessageFactory instance backed by the bundle property file.
   * @throws IllegalArgumentException if the bundle name is empty or the message bundle can't be
   *     located
   */
  public static JhoveMessageFactory getInstance(final String bundleName, final Locale locale)
      throws IllegalArgumentException {
