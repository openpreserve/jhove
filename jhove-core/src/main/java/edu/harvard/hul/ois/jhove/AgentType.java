...
/**
 * This class defines enumerated types for an Agent. Applications will not create or modify
 * AgentTypes, but will use one of the predefined AgentType instances COMMERCIAL, GOVERNMENT,
