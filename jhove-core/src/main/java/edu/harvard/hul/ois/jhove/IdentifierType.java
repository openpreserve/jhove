 ...
 * Applications will not create or modify IdentifierTypes, but will use one of the predefined
 * IdentifierType instances ANSI, DDC, DOI, ECMA, HANDLE, ISO, ISBN, LC, LCCN, NISO, PII, RFC, SICI,
 * URI, URL, URN, or OTHER.
 *
 * @see Identifier
 */
