       ...
       extends edu.harvard.hul.ois.jhove.HandlerBase
{
    ...
    public JsonHandler (String name, String release, int [] date,
    ...
    public void show (RepInfo info)
    {
        ...
        if (module != null) {
            infoBuilder.add("reportingModule", Json.createObjectBuilder()
    ...
    protected JsonObjectBuilder showScalarProperty(Property property) {
        ...
        switch (propType) {
          ...
          case OBJECT:
              ...
              break;
          case DATE:
              Date dt = (java.util.Date) property.getValue ();
            ...
            case ARRAY:
                ...
                switch (property.getType()) {
                  ...
                  case CHARACTER:
                    ...
                    break;
                  case DATE:
                    java.util.Date[] dateArray = (java.util.Date []) property.getValue ();
                    n = dateArray.length;
                    break;
                  case DOUBLE:
    ...
    protected JsonObjectBuilder showNisoBasicDigitalObjectInformation(NisoImageMetadata niso, boolean bMix10)
    {
        ...
        if (s != null) {
            mixBuilder.add("mix:ObjectIdentifier",
    ...
    protected JsonObjectBuilder showNisoBasicImageInformation(NisoImageMetadata niso, boolean bMix10)
    {
        ...
        if (rarray != null) {
          if (bMix10) {
            mixBuilder.add("mix:referenceBlackWhite",
                showArray (rarray));
          } else {
    ...
    protected JsonObjectBuilder showNisoImageAssessmentMetadata(NisoImageMetadata niso, boolean bMix10)
    {
        ...
        if (n != NisoImageMetadata.NULL) {
            if (bMix10) {
              ...
              imeBuilder.add("mix:grayResponseUnit", 
    ...
    protected JsonObjectBuilder showAESAudioMetadata (AESAudioMetadata aes)
    {
        ...
        if (use != null) {
            aesBuilder.add("aes:use", Json.createObjectBuilder()
              .add("aes:useType", use[0])
        ...
        AESAudioMetadata.TimeDesc duration)
    {
        ...
        timerangeBuilder.add("tcf:startTime", Json.createObjectBuilder()
          ...
          .add("tcf:samples", Json.createObjectBuilder()
            .add("tcf:sampleRate", "S" + Integer.toString ((int) sr))
            .add("tcf:numberOfSamples", start.getSamples ())
          ).add("tcf:filmFraming", Json.createObjectBuilder()
        ...
        if (duration != null) {
          ...
          timerangeBuilder.add("tcf:duration", Json.createObjectBuilder()
            .add("tcf:frameCount", 30)
            .add("tcf:timeBase", 1000)
            .add("tcf:videoField", "FIELD_1")
            .add("tcf:countingMode", "NTSC_NON_DROP_FRAME")
