...
public final class RFC1766Lang {
  ...
  /**
   * Returns <code>true</code> if the language code string is syntactically compliant. The primary
   * tag must be either a two-letter code, the letter i, or the letter x (case insensitive); no
   * checking is done against registry lists.
   */
