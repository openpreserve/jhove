...
public class Document {
  ...
  /**
   * Returns a List of Agents, each representing an author of this Document. Returns an empty list
   * if no authors have been listed.
   *
   * @see Agent
   */
  ...
  /**
   * Returns the list of formal Identifiers for this Document. If no Identifiers are given, returns
   * an empty list.
   */
  ...
  /**
   * Returns a List of Agents, each representing a publisher of this Document. If no publishers are
