...
/**
 * This class encapsulates an informational message from a Module, giving information (not
 * necessarily a problem) about the content being analyzed or the way that JHOVE deals with it.
 */
public class InfoMessage extends Message {
   ...
   *
   * @param message Human-readable message giving the information.
   */
   ...
   *
   * @param message Human-readable message giving the information.
   * @param offset The offset in the file relevant to the situation being described.
   */
