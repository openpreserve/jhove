...
public abstract class ModuleBase implements Module {
  ...
  /**
   * Constructors of all subclasses of ModuleBase should call this as a {@code super} constructor.
   *
   * @param name Name of the module
   * @param release Release identifier
   * @param date Last modification date of the module code, in the form of an array of three
   *     numbers. {@code date[0]} is the year, {@code date[1]} the month, and {@code date[2]} the
   *     day.
   * @param format Array of format names supported by the module
   * @param coverage Details as to the specific format versions or variants that are supported by
   *     the module
   * @param mimeType Array of MIME type strings for formats supported by the module
   * @param wellFormedNote Brief explanation of what constitutes well-formed content
   * @param validityNote Brief explanation of what constitutes valid content
   * @param repInfoNote Note pertaining to RepInfo (may be null)
   * @param note Additional information about the module (may be null)
   * @param rights Copyright notice for the module
   * @param isRandomAccess {@code true} if the module treats content as random-access data, {@code
   *     false} if it treats content as stream data
   */
  ...
  /**
   * Reset parameter settings. Returns to a default state without any parameters. The default method
   * clears the saved parameter.
   */
  @Override
  ...
  /**
   * Per-action initialization. May be called multiple times. The default method does nothing but
   * save its parameter.
   */
  @Override
  ...
  /**
   * Returns <code>true</code> if the dominant "endianness" of the module, or the current file being
   ...
   *
   * <p>Every module must initialize the value of _bigEndian for this function, or else assign its
  ...
  /**
   * Returns a list of <code>Document</code> objects (one for each specification document of the
  ...
  /**
   * Return the random access flag (true if the module operates on random access files, false if it
   * operates on streams)
   */
  @Override
  ...
  /**
   * Returns <code>true</code> if the module supports a given named feature, and <code>false</code>
   * if the feature is unsupported or unknown. Feature names are case sensitive.
   *
   * <p>It is recommended that features be named using package nomenclature. The following features
  ...
  /**
   * Set the value of the validityNote property, which briefly explains the validity criteria of
   * this Module.
   */
  ...
  /**
   * Set the value of the CRC32 calculated for the content object. The checksum-like functions can
   * be set by the caller. Setting any of these creates the assumption that the calculation is
   * already done, and sets the checksumFinished flag to inhibit recalculation.
   */
  ...
  /**
   * Set the degree of verbosity desired from the module. The setting of <code>param</code> can
   ...
   *
   * @param file A File object representing the object to be parsed
  ...
  /**
   * Initializes the state of the module for parsing. This should be called early in each module's
   * parse() method. If a module overrides it to provide additional functionality, the module's
   ...
   * returns an INTEGER property, and <code>labels</code> and <code>index</code> are unused.
   * Otherwise, returns a STRING property, with the string being the element of <code>labels</code>
   * whose index is the index of <code>value</code> in <code>index</code>.
   */
