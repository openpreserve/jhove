...
/**
 * This class encapsulates an error message from a Module, representing a problem in the content
 * being analyzed.
 */
public class ErrorMessage extends Message {
   ...
   *
   * @param message Human-readable message describing the problem.
   * @param offset The offset in the file at which the problem was detected.
   */
